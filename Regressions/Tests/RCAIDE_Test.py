...
from RCAIDE.Methods.Power.Battery.Sizing                 import initialize_from_circuit_configuration,  initialize_from_mass
...
def main():     
    ...
    RPM        = results.segments.climb.conditions.energy.bus.propulsor.rotor.rpm[3][0]  
...
def vehicle_setup():
    ...
    motor.nominal_voltage         = bat.pack.maximum_voltage*0.75
...
def mission_setup(analyses): 
    ...
    segment.air_speed_start                                  = 120.91 * Units['mph'] 
