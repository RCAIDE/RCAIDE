...
from RCAIDE.Methods.Energy.Propulsors.Converters.Turbojet  import design_turbojet
...
def vehicle_setup():
    ...
    #  Turbofan Network
    #------------------------------------------------------------------------------------------------------------------------------------  
    net                                            = RCAIDE.Energy.Networks.Turbojet_Engine_Network() 
    ...
    #------------------------------------------------------------------------------------------------------------------------------------   
    outer_right_turbojet                              = RCAIDE.Energy.Propulsors.Turbojet()  
