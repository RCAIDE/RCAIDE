...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_deflect_control_surfaces(VD,geometry,settings):
    """ 
...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_deflect_control_surface(VD,wing):
    """ 
...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_deflect_control_surface_strip(wing, raw_VD, is_first_strip, sym_sign):
...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_make_hinge_quaternion(point_on_line, direction_unit_vector, rotation_angle):
...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_rotate_points_with_quaternion(quat, points):
...
def deflect_control_surfaces(State, Settings, System):
	...
	results = func_deflect_control_surfaces('VD', 'geometry', 'settings')
...
def deflect_control_surface(State, Settings, System):
	#TODO: VD   = [Replace With State, Settings, or System Attribute]
	#TODO: wing = [Replace With State, Settings, or System Attribute]

	results = func_deflect_control_surface('VD', 'wing')
	#TODO: [Replace results with the output of the original function]
...
def deflect_control_surface_strip(State, Settings, System):
	#TODO: wing           = [Replace With State, Settings, or System Attribute]
	#TODO: raw_VD         = [Replace With State, Settings, or System Attribute]
	#TODO: is_first_strip = [Replace With State, Settings, or System Attribute]
	#TODO: sym_sign       = [Replace With State, Settings, or System Attribute]

	results = func_deflect_control_surface_strip('wing', 'raw_VD', 'is_first_strip', 'sym_sign')
	#TODO: [Replace results with the output of the original function]
...
def make_hinge_quaternion(State, Settings, System):
	#TODO: point_on_line         = [Replace With State, Settings, or System Attribute]
	#TODO: direction_unit_vector = [Replace With State, Settings, or System Attribute]
	#TODO: rotation_angle        = [Replace With State, Settings, or System Attribute]

	results = func_make_hinge_quaternion('point_on_line', 'direction_unit_vector', 'rotation_angle')
	#TODO: [Replace results with the output of the original function]
...
def rotate_points_with_quaternion(State, Settings, System):
	#TODO: quat   = [Replace With State, Settings, or System Attribute]
	#TODO: points = [Replace With State, Settings, or System Attribute]

	results = func_rotate_points_with_quaternion('quat', 'points')
	#TODO: [Replace results with the output of the original function]
...
def flip_1(State, Settings, System):
	#TODO: A  = [Replace With State, Settings, or System Attribute]
	#TODO: B  = [Replace With State, Settings, or System Attribute]
	#TODO: T1 = [Replace With State, Settings, or System Attribute]
	#TODO: T2 = [Replace With State, Settings, or System Attribute]

	results = func_flip_1('A', 'B', 'T1', 'T2')
	#TODO: [Replace results with the output of the original function]
...
def flip_2(State, Settings, System):
	#TODO: A  = [Replace With State, Settings, or System Attribute]
	#TODO: B  = [Replace With State, Settings, or System Attribute]
	#TODO: T1 = [Replace With State, Settings, or System Attribute]
	#TODO: T2 = [Replace With State, Settings, or System Attribute]

	results = func_flip_2('A', 'B', 'T1', 'T2')
	#TODO: [Replace results with the output of the original function]
