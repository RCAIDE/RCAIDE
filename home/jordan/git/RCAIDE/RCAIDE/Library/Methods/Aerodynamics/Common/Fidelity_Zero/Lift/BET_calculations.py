...
import numpy as np
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_compute_airfoil_aerodynamics(beta,c,r,R,B,Wa,Wt,a,nu,airfoils,a_loc,ctrl_pts,Nr,Na,tc,use_2d_analysis):
    """
...
def func_compute_inflow_and_tip_loss(r,R,Wa,Wt,B,et1=1,et2=1,et3=1):
    """
...
def compute_airfoil_aerodynamics(State, Settings, System):
	...
	results = func_compute_airfoil_aerodynamics('beta', 'c', 'r', 'R', 'B', 'Wa', 'Wt', 'a', 'nu', 'airfoils', 'a_loc', 'ctrl_pts', 'Nr', 'Na', 'tc', 'use_2d_analysis')
...
def compute_inflow_and_tip_loss(State, Settings, System):
	#TODO: r   = [Replace With State, Settings, or System Attribute]
	#TODO: R   = [Replace With State, Settings, or System Attribute]
	#TODO: Wa  = [Replace With State, Settings, or System Attribute]
	#TODO: Wt  = [Replace With State, Settings, or System Attribute]
	...
	results = func_compute_inflow_and_tip_loss('r', 'R', 'Wa', 'Wt', 'B', 'et1', 'et2', 'et3')
	#TODO: [Replace results with the output of the original function]
