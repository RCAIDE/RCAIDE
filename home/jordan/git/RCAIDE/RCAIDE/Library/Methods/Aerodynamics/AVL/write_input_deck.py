...
## @ingroup Methods-Aerodynamics-AVL
def func_write_input_deck(avl_object,trim_aircraft,control_surfaces):
...
def func_make_case_command(avl_object,case,trim_aircraft,control_surfaces):
...
def func_make_trim_text_command(case):
...
def func_make_roll_rate_text_command(case):
...
def func_make_pitch_rate_text_command(case):
...
def func_make_beta_text_command(case):
    """ Writes the roll rate command currently for a specified flight  condition
    Assumptions:
        None
...
def func_control_surface_deflection_command(case,aircraft): 
...
def write_input_deck(State, Settings, System):
	#TODO: avl_object       = [Replace With State, Settings, or System Attribute]
	#TODO: trim_aircraft    = [Replace With State, Settings, or System Attribute]
	#TODO: control_surfaces = [Replace With State, Settings, or System Attribute]

	results = func_write_input_deck('avl_object', 'trim_aircraft', 'control_surfaces')
...
def make_case_command(State, Settings, System):
	#TODO: avl_object       = [Replace With State, Settings, or System Attribute]
	#TODO: case             = [Replace With State, Settings, or System Attribute]
	#TODO: trim_aircraft    = [Replace With State, Settings, or System Attribute]
	#TODO: control_surfaces = [Replace With State, Settings, or System Attribute]

	results = func_make_case_command('avl_object', 'case', 'trim_aircraft', 'control_surfaces')
	#TODO: [Replace results with the output of the original function]
...
def make_trim_text_command(State, Settings, System):
	#TODO: case = [Replace With State, Settings, or System Attribute]

	results = func_make_trim_text_command('case',)
	#TODO: [Replace results with the output of the original function]
...
def make_roll_rate_text_command(State, Settings, System):
	#TODO: case = [Replace With State, Settings, or System Attribute]

	results = func_make_roll_rate_text_command('case',)
	#TODO: [Replace results with the output of the original function]
...
def make_pitch_rate_text_command(State, Settings, System):
	#TODO: case = [Replace With State, Settings, or System Attribute]

	results = func_make_pitch_rate_text_command('case',)
	#TODO: [Replace results with the output of the original function]
...
def make_beta_text_command(State, Settings, System):
	#TODO: case = [Replace With State, Settings, or System Attribute]

	results = func_make_beta_text_command('case',)
	#TODO: [Replace results with the output of the original function]
...
def control_surface_deflection_command(State, Settings, System):
	#TODO: case     = [Replace With State, Settings, or System Attribute]
	#TODO: aircraft = [Replace With State, Settings, or System Attribute]

	results = func_control_surface_deflection_command('case', 'aircraft')
	#TODO: [Replace results with the output of the original function]
