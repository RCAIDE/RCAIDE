...
class Wing(Data):
	...
	def func_append_section(self,section):
...
class Section(Data):
	...
	def func_append_control_surface(self,control):
...
class Control_Surface_Data(Data):
	...
	def func_append_control_surface_result(self,control_res):
		""" Adds a control_surface to the wing section in AVL
		"""   		
...
def func___defaults__(State, Settings, System):
...
def append_section(State, Settings, System):
	#TODO: self    = [Replace With State, Settings, or System Attribute]
	#TODO: section = [Replace With State, Settings, or System Attribute]

	results = func_append_section('self', 'section')
	#TODO: [Replace results with the output of the original function]
...
def append_control_surface(State, Settings, System):
	#TODO: self    = [Replace With State, Settings, or System Attribute]
	#TODO: control = [Replace With State, Settings, or System Attribute]

	results = func_append_control_surface('self', 'control')
	#TODO: [Replace results with the output of the original function]
...
def append_control_surface_result(State, Settings, System):
	#TODO: self        = [Replace With State, Settings, or System Attribute]
	#TODO: control_res = [Replace With State, Settings, or System Attribute]

	results = func_append_control_surface_result('self', 'control_res')
	#TODO: [Replace results with the output of the original function]
