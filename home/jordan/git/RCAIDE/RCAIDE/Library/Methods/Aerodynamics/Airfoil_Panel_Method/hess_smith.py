...
## @ingroup Methods-Aerodynamics-Airfoil_Panel_Method
def func_hess_smith(x_coord,y_coord,alpha,Re,npanel):
...
def hess_smith(State, Settings, System):
	#TODO: x_coord = [Replace With State, Settings, or System Attribute]
	#TODO: y_coord = [Replace With State, Settings, or System Attribute]
	...
	results = func_hess_smith('x_coord', 'y_coord', 'alpha', 'Re', 'npanel')
