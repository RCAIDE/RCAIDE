...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Helper_Functions
def func_compressible_mixed_flat_plate(Re,Ma,Tc,xt):
...
def compressible_mixed_flat_plate(State, Settings, System):
	#TODO: Re = [Replace With State, Settings, or System Attribute]
	#TODO: Ma = [Replace With State, Settings, or System Attribute]
	#TODO: Tc = [Replace With State, Settings, or System Attribute]
	#TODO: xt = [Replace With State, Settings, or System Attribute]

	results = func_compressible_mixed_flat_plate('Re', 'Ma', 'Tc', 'xt')
