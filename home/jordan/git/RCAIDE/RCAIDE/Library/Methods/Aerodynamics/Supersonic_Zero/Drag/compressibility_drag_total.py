...
# ----------------------------------------------------------------------
## @ingroup Methods-Aerodynamics-Supersonic_Zero-Drag
def func_compressibility_drag_total(state,settings,geometry):
    ...
    def func_CD_v_para(M,a_vertex): # parabolic approximation of drag rise in the transonic region
...
## @ingroup Methods-Aerodynamics-Supersonic_Zero-Drag
def func_lift_wave_drag(conditions,configuration,wing,Sref_main):
...
## @ingroup Methods-Aerodynamics-Supersonic_Zero-Drag
def func_drag_div(Mc_ii,wing,cl,Sref_main):
...
def compressibility_drag_total(State, Settings, System):
	...
	results = func_compressibility_drag_total('state', 'settings', 'geometry')
...
def lift_wave_drag(State, Settings, System):
	...
	results = func_lift_wave_drag('conditions', 'configuration', 'wing', 'Sref_main')
	#TODO: [Replace results with the output of the original function]
