...
def func_generate_propeller_grid(prop, grid_settings, plot_grid=True):
...
def generate_propeller_grid(State, Settings, System):
	...
	results = func_generate_propeller_grid('prop', 'grid_settings', 'plot_grid')
