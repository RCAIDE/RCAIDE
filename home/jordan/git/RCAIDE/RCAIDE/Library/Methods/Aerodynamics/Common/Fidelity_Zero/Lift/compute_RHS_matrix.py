...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_compute_RHS_matrix(delta,phi,conditions,settings,geometry,propeller_wake_model):
...
def func_build_RHS(VD, conditions, settings, aoa_distribution, delta, phi, PSI_distribution,
              Vx_ind_total, Vy_ind_total, Vz_ind_total, V_distribution, dt):
...
def compute_RHS_matrix(State, Settings, System):
	...
	results = func_compute_RHS_matrix('delta', 'phi', 'conditions', 'settings', 'geometry', 'propeller_wake_model')
...
def build_RHS(State, Settings, System):
	...
	results = func_build_RHS('VD', 'conditions', 'settings', 'aoa_distribution', 'delta', 'phi', 'PSI_distribution', 'Vx_ind_total', 'Vy_ind_total', 'Vz_ind_total', 'V_distribution', 'dt')
	#TODO: [Replace results with the output of the original function]
