...
## @ingroup Methods-Aerodynamics-Common-Gas_Dynamics
def func_oblique_shock_relations(M0,gamma,theta,beta):
...
## @ingroup Methods-Aerodynamics-Common-Gas_Dynamics
def func_theta_beta_mach(M0,gamma,theta,n=0):
...
def oblique_shock_relations(State, Settings, System):
	...
	results = func_oblique_shock_relations('M0', 'gamma', 'theta', 'beta')
...
def theta_beta_mach(State, Settings, System):
	#TODO: M0    = [Replace With State, Settings, or System Attribute]
	#TODO: gamma = [Replace With State, Settings, or System Attribute]
	#TODO: theta = [Replace With State, Settings, or System Attribute]
	#TODO: n     = [Replace With State, Settings, or System Attribute]

	results = func_theta_beta_mach('M0', 'gamma', 'theta', 'n')
	#TODO: [Replace results with the output of the original function]
