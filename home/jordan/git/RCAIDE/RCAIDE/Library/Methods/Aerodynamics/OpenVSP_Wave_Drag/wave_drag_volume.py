...
## @ingroup Methods-Aerodynamics-OpenVSP_Wave_Drag
def func_wave_drag_volume(conditions,geometry,flag105,num_slices=20,num_rots=10):
...
def wave_drag_volume(State, Settings, System):
	...
	#TODO: num_slices = [Replace With State, Settings, or System Attribute]
	#TODO: num_rots   = [Replace With State, Settings, or System Attribute]

	results = func_wave_drag_volume('conditions', 'geometry', 'flag105', 'num_slices', 'num_rots')
