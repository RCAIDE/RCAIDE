...
def func_compute_wing_wake(geometry, conditions, x, grid_settings, VLM_settings, evaluation_points=None,viscous_wake=True, plot_grid=False, plot_wake=False):
    """
...
def compute_wing_wake(State, Settings, System):
	...
	#TODO: grid_settings     = [Replace With State, Settings, or System Attribute]
	#TODO: VLM_settings      = [Replace With State, Settings, or System Attribute]
	#TODO: evaluation_points = [Replace With State, Settings, or System Attribute]
	#TODO: viscous_wake      = [Replace With State, Settings, or System Attribute]
	#TODO: plot_grid         = [Replace With State, Settings, or System Attribute]
	#TODO: plot_wake         = [Replace With State, Settings, or System Attribute]

	results = func_compute_wing_wake('geometry', 'conditions', 'x', 'grid_settings', 'VLM_settings', 'evaluation_points', 'viscous_wake', 'plot_grid', 'plot_wake')
