...
def func_translate_avl_wing(suave_wing):
...
def func_translate_avl_body(suave_body):
...
def func_populate_wing_sections(avl_wing,suave_wing): 
...
def func_append_avl_wing_control_surfaces(suave_wing,avl_wing,semispan,root_chord_percent,tip_chord_percent,tip_percent_span,root_percent_span,root_twist,tip_twist,tip_airfoil,seg_tag,dihedral,origin,sweep):
    ...
    return 
def func_populate_body_sections(avl_body,suave_body):
...
def translate_avl_wing(State, Settings, System):
	#TODO: suave_wing = [Replace With State, Settings, or System Attribute]

	results = func_translate_avl_wing('suave_wing',)
...
def translate_avl_body(State, Settings, System):
	#TODO: suave_body = [Replace With State, Settings, or System Attribute]

	results = func_translate_avl_body('suave_body',)
	#TODO: [Replace results with the output of the original function]
...
def populate_wing_sections(State, Settings, System):
	#TODO: avl_wing   = [Replace With State, Settings, or System Attribute]
	#TODO: suave_wing = [Replace With State, Settings, or System Attribute]

	results = func_populate_wing_sections('avl_wing', 'suave_wing')
	#TODO: [Replace results with the output of the original function]
...
def append_avl_wing_control_surfaces(State, Settings, System):
	#TODO: suave_wing         = [Replace With State, Settings, or System Attribute]
	#TODO: avl_wing           = [Replace With State, Settings, or System Attribute]
	#TODO: semispan           = [Replace With State, Settings, or System Attribute]
	#TODO: root_chord_percent = [Replace With State, Settings, or System Attribute]
	#TODO: tip_chord_percent  = [Replace With State, Settings, or System Attribute]
	#TODO: tip_percent_span   = [Replace With State, Settings, or System Attribute]
	#TODO: root_percent_span  = [Replace With State, Settings, or System Attribute]
	#TODO: root_twist         = [Replace With State, Settings, or System Attribute]
	#TODO: tip_twist          = [Replace With State, Settings, or System Attribute]
	#TODO: tip_airfoil        = [Replace With State, Settings, or System Attribute]
	#TODO: seg_tag            = [Replace With State, Settings, or System Attribute]
	#TODO: dihedral           = [Replace With State, Settings, or System Attribute]
	#TODO: origin             = [Replace With State, Settings, or System Attribute]
	#TODO: sweep              = [Replace With State, Settings, or System Attribute]

	results = func_append_avl_wing_control_surfaces('suave_wing', 'avl_wing', 'semispan', 'root_chord_percent', 'tip_chord_percent', 'tip_percent_span', 'root_percent_span', 'root_twist', 'tip_twist', 'tip_airfoil', 'seg_tag', 'dihedral', 'origin', 'sweep')
	#TODO: [Replace results with the output of the original function]
...
def populate_body_sections(State, Settings, System):
	#TODO: avl_body   = [Replace With State, Settings, or System Attribute]
	#TODO: suave_body = [Replace With State, Settings, or System Attribute]

	results = func_populate_body_sections('avl_body', 'suave_body')
	#TODO: [Replace results with the output of the original function]
