...
## @ingroup Methods-Aerodynamics-Supersonic_Zero-Drag
def func_parasite_drag_nacelle(state,settings,nacelle):
...
def parasite_drag_nacelle(State, Settings, System):
	...
	results = func_parasite_drag_nacelle('state', 'settings', 'nacelle')
