...
def func_compute_propeller_nonuniform_freestream(prop, upstream_wake,conditions):
...
def compute_propeller_nonuniform_freestream(State, Settings, System):
	#TODO: prop          = [Replace With State, Settings, or System Attribute]
	#TODO: upstream_wake = [Replace With State, Settings, or System Attribute]
	#TODO: conditions    = [Replace With State, Settings, or System Attribute]

	results = func_compute_propeller_nonuniform_freestream('prop', 'upstream_wake', 'conditions')
