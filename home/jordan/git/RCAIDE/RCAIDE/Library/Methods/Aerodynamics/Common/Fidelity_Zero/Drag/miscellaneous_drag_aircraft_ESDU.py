...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Drag
def func_miscellaneous_drag_aircraft_ESDU(state,settings,geometry):
...
def miscellaneous_drag_aircraft_ESDU(State, Settings, System):
	...
	results = func_miscellaneous_drag_aircraft_ESDU('state', 'settings', 'geometry')
