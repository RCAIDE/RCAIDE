...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Drag
def func_parasite_drag_wing(state,settings,geometry):
...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Drag
def func_compute_parasite_drag(re,mac_w,Mc,Tc,xtu,xtl,sweep_w,t_c_w,Sref,Swet,C):
    """Computes the parasite drag due to wings
...
def parasite_drag_wing(State, Settings, System):
	...
	results = func_parasite_drag_wing('state', 'settings', 'geometry')
...
def compute_parasite_drag(State, Settings, System):
	#TODO: re      = [Replace With State, Settings, or System Attribute]
	#TODO: mac_w   = [Replace With State, Settings, or System Attribute]
	#TODO: Mc      = [Replace With State, Settings, or System Attribute]
	#TODO: Tc      = [Replace With State, Settings, or System Attribute]
	#TODO: xtu     = [Replace With State, Settings, or System Attribute]
	#TODO: xtl     = [Replace With State, Settings, or System Attribute]
	#TODO: sweep_w = [Replace With State, Settings, or System Attribute]
	#TODO: t_c_w   = [Replace With State, Settings, or System Attribute]
	#TODO: Sref    = [Replace With State, Settings, or System Attribute]
	#TODO: Swet    = [Replace With State, Settings, or System Attribute]
	#TODO: C       = [Replace With State, Settings, or System Attribute]

	results = func_compute_parasite_drag('re', 'mac_w', 'Mc', 'Tc', 'xtu', 'xtl', 'sweep_w', 't_c_w', 'Sref', 'Swet', 'C')
	#TODO: [Replace results with the output of the original function]
