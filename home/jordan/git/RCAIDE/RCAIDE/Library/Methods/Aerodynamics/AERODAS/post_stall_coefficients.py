...
## @ingroup Methods-Aerodynamics-AERODAS
def func_post_stall_coefficients(state,settings,geometry):
...
def post_stall_coefficients(State, Settings, System):
	...
	results = func_post_stall_coefficients('state', 'settings', 'geometry')
