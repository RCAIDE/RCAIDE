...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Helper_Functions
def func_compressible_turbulent_flat_plate(Re,Ma,Tc):
...
def compressible_turbulent_flat_plate(State, Settings, System):
	...
	results = func_compressible_turbulent_flat_plate('Re', 'Ma', 'Tc')
