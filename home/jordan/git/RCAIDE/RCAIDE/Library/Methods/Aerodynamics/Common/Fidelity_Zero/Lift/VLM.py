...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_VLM(conditions,settings,geometry):
...
# ----------------------------------------------------------------------
def func_compute_rotation_effects(VD, settings, EW_small, GAMMA, len_mach, X, CHORD, XLE, XBAR, 
                             rhs, COSINP, SINALF, PITCH, ROLL, YAW, STB, RNMAX):
...
# ----------------------------------------------------------------------
def func_strip_cumsum(arr, chord_breaks, strip_lengths):
...
def VLM(State, Settings, System):
	...
	results = func_VLM('conditions', 'settings', 'geometry')
...
def compute_rotation_effects(State, Settings, System):
	...
	results = func_compute_rotation_effects('VD', 'settings', 'EW_small', 'GAMMA', 'len_mach', 'X', 'CHORD', 'XLE', 'XBAR', 'rhs', 'COSINP', 'SINALF', 'PITCH', 'ROLL', 'YAW', 'STB', 'RNMAX')
	#TODO: [Replace results with the output of the original function]
...
def strip_cumsum(State, Settings, System):
	...
	results = func_strip_cumsum('arr', 'chord_breaks', 'strip_lengths')
	#TODO: [Replace results with the output of the original function]
