...
def func_generate_wing_wake_grid(geometry, H, L, hf, x_plane, Nzo=20, Nzf=35, Nyo=20, plot_grid=False):
...
def generate_wing_wake_grid(State, Settings, System):
	...
	#TODO: hf        = [Replace With State, Settings, or System Attribute]
	#TODO: x_plane   = [Replace With State, Settings, or System Attribute]
	#TODO: Nzo       = [Replace With State, Settings, or System Attribute]
	#TODO: Nzf       = [Replace With State, Settings, or System Attribute]
	#TODO: Nyo       = [Replace With State, Settings, or System Attribute]
	#TODO: plot_grid = [Replace With State, Settings, or System Attribute]

	results = func_generate_wing_wake_grid('geometry', 'H', 'L', 'hf', 'x_plane', 'Nzo', 'Nzf', 'Nyo', 'plot_grid')
