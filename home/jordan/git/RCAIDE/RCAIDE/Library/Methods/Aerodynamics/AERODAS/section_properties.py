...
def func_section_properties(state,settings,geometry):
...
def section_properties(State, Settings, System):
	...
	results = func_section_properties('state', 'settings', 'geometry')
