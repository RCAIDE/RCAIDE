...
## @ingroup Methods-Aerodynamics-OpenVSP_Wave_Drag
def func_lift_wave_drag(conditions,configuration,wing,k,Sref_main,flag105):
...
def lift_wave_drag(State, Settings, System):
	...
	#TODO: k             = [Replace With State, Settings, or System Attribute]
	#TODO: Sref_main     = [Replace With State, Settings, or System Attribute]
	#TODO: flag105       = [Replace With State, Settings, or System Attribute]

	results = func_lift_wave_drag('conditions', 'configuration', 'wing', 'k', 'Sref_main', 'flag105')
	#TODO: [Replace results with the output of the original function]
