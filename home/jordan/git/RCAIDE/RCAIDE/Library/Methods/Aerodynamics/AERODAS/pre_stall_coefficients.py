...
## @ingroup Methods-Aerodynamics-AERODAS
def func_pre_stall_coefficients(state,settings,geometry):
...
def pre_stall_coefficients(State, Settings, System):
	...
	results = func_pre_stall_coefficients('state', 'settings', 'geometry')
