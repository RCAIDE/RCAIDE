...
## @ingroup Methods-Aerodynamics-AERODAS
def func_setup_data(state,settings,geometry):
...
## @ingroup Methods-Aerodynamics-AERODAS
def func_lift_drag_total(state,settings,geometry):
...
## @ingroup Methods-Aerodynamics-AERODAS
def func_drag_total(state,settings,geometry):
...
def setup_data(State, Settings, System):
	...
	results = func_setup_data('state', 'settings', 'geometry')
...
def lift_drag_total(State, Settings, System):
	#TODO: state    = [Replace With State, Settings, or System Attribute]
	#TODO: settings = [Replace With State, Settings, or System Attribute]
	#TODO: geometry = [Replace With State, Settings, or System Attribute]

	results = func_lift_drag_total('state', 'settings', 'geometry')
	#TODO: [Replace results with the output of the original function]
...
def drag_total(State, Settings, System):
	#TODO: state    = [Replace With State, Settings, or System Attribute]
	#TODO: settings = [Replace With State, Settings, or System Attribute]
	#TODO: geometry = [Replace With State, Settings, or System Attribute]

	results = func_drag_total('state', 'settings', 'geometry')
	#TODO: [Replace results with the output of the original function]
