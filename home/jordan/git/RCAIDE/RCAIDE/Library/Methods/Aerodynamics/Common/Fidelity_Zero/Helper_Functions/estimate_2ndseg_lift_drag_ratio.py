...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Helper_Functions
def func_estimate_2ndseg_lift_drag_ratio(state,settings,geometry):
...
def estimate_2ndseg_lift_drag_ratio(State, Settings, System):
	...
	results = func_estimate_2ndseg_lift_drag_ratio('state', 'settings', 'geometry')
