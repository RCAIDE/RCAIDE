...
# ------------------------------------------------------------------  
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_make_VLM_wings(geometry, settings):
...
# ------------------------------------------------------------------      
def func_copy_wings(original_wings):
...
def func_copy_large_container(large_container, type_str):
...
def func_copy_data_from_paths(old_object, paths):
...
def func_recursive_set(data_obj, path, val):
...
# ------------------------------------------------------------------  
def func_make_cs_wing_from_cs(cs, seg_a, seg_b, wing, cs_ID):
...
def func_convert_to_segmented_wing(wing):
...
# ------------------------------------------------------------------  
def func_add_span_break(span_break, span_breaks):
...
def func_reprocess_span_breaks(span_breaks):
...
# ------------------------------------------------------------------ 
def func_make_span_break_from_segment(seg):
...
def func_make_span_breaks_from_cs(cs, seg_a, seg_b, cs_wing, cs_ID):
...
def func_make_span_break(cs_ID, LE_TE, ib_ob, span_frac, chord_cut, Airfoil,
                    dihedral_ob, sweep_ob_QC, sweep_ob_LE, twist, local_chord,
                    x_offset, dih_offset):
...
def func_make_span_break_tag(span_break):
...
def make_VLM_wings(State, Settings, System):
	...
	results = func_make_VLM_wings('geometry', 'settings')
...
def copy_wings(State, Settings, System):
	#TODO: original_wings = [Replace With State, Settings, or System Attribute]

	results = func_copy_wings('original_wings',)
	#TODO: [Replace results with the output of the original function]
...
def copy_large_container(State, Settings, System):
	#TODO: large_container = [Replace With State, Settings, or System Attribute]
	#TODO: type_str        = [Replace With State, Settings, or System Attribute]

	results = func_copy_large_container('large_container', 'type_str')
	#TODO: [Replace results with the output of the original function]
...
def copy_data_from_paths(State, Settings, System):
	#TODO: old_object = [Replace With State, Settings, or System Attribute]
	#TODO: paths      = [Replace With State, Settings, or System Attribute]

	results = func_copy_data_from_paths('old_object', 'paths')
	#TODO: [Replace results with the output of the original function]
...
def recursive_set(State, Settings, System):
	#TODO: data_obj = [Replace With State, Settings, or System Attribute]
	#TODO: path     = [Replace With State, Settings, or System Attribute]
	#TODO: val      = [Replace With State, Settings, or System Attribute]

	results = func_recursive_set('data_obj', 'path', 'val')
	#TODO: [Replace results with the output of the original function]
...
def get_paths(State, Settings, System):
	#TODO: type_str = [Replace With State, Settings, or System Attribute]

	results = func_get_paths('type_str',)
	#TODO: [Replace results with the output of the original function]
...
def make_cs_wing_from_cs(State, Settings, System):
	#TODO: cs    = [Replace With State, Settings, or System Attribute]
	...
	#TODO: cs_ID = [Replace With State, Settings, or System Attribute]

	results = func_make_cs_wing_from_cs('cs', 'seg_a', 'seg_b', 'wing', 'cs_ID')
	#TODO: [Replace results with the output of the original function]
...
def convert_to_segmented_wing(State, Settings, System):
	#TODO: wing = [Replace With State, Settings, or System Attribute]

	results = func_convert_to_segmented_wing('wing',)
	#TODO: [Replace results with the output of the original function]
...
def add_span_break(State, Settings, System):
	#TODO: span_break  = [Replace With State, Settings, or System Attribute]
	#TODO: span_breaks = [Replace With State, Settings, or System Attribute]

	results = func_add_span_break('span_break', 'span_breaks')
	#TODO: [Replace results with the output of the original function]
...
def reprocess_span_breaks(State, Settings, System):
	#TODO: span_breaks = [Replace With State, Settings, or System Attribute]

	results = func_reprocess_span_breaks('span_breaks',)
	#TODO: [Replace results with the output of the original function]
...
def make_span_break_from_segment(State, Settings, System):
	#TODO: seg = [Replace With State, Settings, or System Attribute]

	results = func_make_span_break_from_segment('seg',)
	#TODO: [Replace results with the output of the original function]
...
def make_span_breaks_from_cs(State, Settings, System):
	#TODO: cs      = [Replace With State, Settings, or System Attribute]
	#TODO: seg_a   = [Replace With State, Settings, or System Attribute]
	#TODO: seg_b   = [Replace With State, Settings, or System Attribute]
	#TODO: cs_wing = [Replace With State, Settings, or System Attribute]
	#TODO: cs_ID   = [Replace With State, Settings, or System Attribute]

	results = func_make_span_breaks_from_cs('cs', 'seg_a', 'seg_b', 'cs_wing', 'cs_ID')
	#TODO: [Replace results with the output of the original function]
...
def make_span_break(State, Settings, System):
	#TODO: cs_ID       = [Replace With State, Settings, or System Attribute]
	#TODO: LE_TE       = [Replace With State, Settings, or System Attribute]
	#TODO: ib_ob       = [Replace With State, Settings, or System Attribute]
	#TODO: span_frac   = [Replace With State, Settings, or System Attribute]
	#TODO: chord_cut   = [Replace With State, Settings, or System Attribute]
	#TODO: Airfoil     = [Replace With State, Settings, or System Attribute]
	#TODO: dihedral_ob = [Replace With State, Settings, or System Attribute]
	#TODO: sweep_ob_QC = [Replace With State, Settings, or System Attribute]
	#TODO: sweep_ob_LE = [Replace With State, Settings, or System Attribute]
	#TODO: twist       = [Replace With State, Settings, or System Attribute]
	#TODO: local_chord = [Replace With State, Settings, or System Attribute]
	#TODO: x_offset    = [Replace With State, Settings, or System Attribute]
	#TODO: dih_offset  = [Replace With State, Settings, or System Attribute]

	results = func_make_span_break('cs_ID', 'LE_TE', 'ib_ob', 'span_frac', 'chord_cut', 'Airfoil', 'dihedral_ob', 'sweep_ob_QC', 'sweep_ob_LE', 'twist', 'local_chord', 'x_offset', 'dih_offset')
	#TODO: [Replace results with the output of the original function]
...
def make_span_break_tag(State, Settings, System):
	#TODO: span_break = [Replace With State, Settings, or System Attribute]

	results = func_make_span_break_tag('span_break',)
	#TODO: [Replace results with the output of the original function]
