...
## @ingroup Methods-Aerodynamics-AERODAS
def func_finite_aspect_ratio(state,settings,geometry):
...
def finite_aspect_ratio(State, Settings, System):
	...
	results = func_finite_aspect_ratio('state', 'settings', 'geometry')
