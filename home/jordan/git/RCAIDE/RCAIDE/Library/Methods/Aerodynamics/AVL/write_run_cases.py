...
def func_write_run_cases(avl_object,trim_aircraft):
...
def func_make_controls_case_text(cs_names,avl_aircraft):
...
def write_run_cases(State, Settings, System):
	...
	results = func_write_run_cases('avl_object', 'trim_aircraft')
...
def make_controls_case_text(State, Settings, System):
	#TODO: cs_names     = [Replace With State, Settings, or System Attribute]
	#TODO: avl_aircraft = [Replace With State, Settings, or System Attribute]

	results = func_make_controls_case_text('cs_names', 'avl_aircraft')
	#TODO: [Replace results with the output of the original function]
