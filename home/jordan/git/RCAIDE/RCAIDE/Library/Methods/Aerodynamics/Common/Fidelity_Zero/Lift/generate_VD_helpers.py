...
# ----------------------------------------------------------------------
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift    
def func_postprocess_VD(VD, settings):
    """ 
...
# ----------------------------------------------------------------------
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_compute_panel_area(VD):
...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_compute_unit_normal(VD):
...
def compute_panel_area(State, Settings, System):
	#TODO: VD = [Replace With State, Settings, or System Attribute]

	results = func_compute_panel_area('VD',)
	#TODO: [Replace results with the output of the original function]
...
def compute_unit_normal(State, Settings, System):
	#TODO: VD = [Replace With State, Settings, or System Attribute]

	results = func_compute_unit_normal('VD',)
	#TODO: [Replace results with the output of the original function]
