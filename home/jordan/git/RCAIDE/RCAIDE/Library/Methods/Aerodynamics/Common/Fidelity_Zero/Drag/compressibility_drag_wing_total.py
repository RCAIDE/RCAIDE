...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Drag
def func_compressibility_drag_wing_total(state,settings,geometry):
...
def compressibility_drag_wing_total(State, Settings, System):
	...
	results = func_compressibility_drag_wing_total('state', 'settings', 'geometry')
