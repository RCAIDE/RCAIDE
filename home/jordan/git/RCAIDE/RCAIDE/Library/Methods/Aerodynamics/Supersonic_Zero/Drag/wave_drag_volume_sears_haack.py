...
## @ingroup Methods-Aerodynamics-Supersonic_Zero-Drag
def func_wave_drag_volume_sears_haack(vehicle, mach, scaling_factor, sears_haack_type = 3):
...
def wave_drag_volume_sears_haack(State, Settings, System):
	#TODO: vehicle          = [Replace With State, Settings, or System Attribute]
	#TODO: mach             = [Replace With State, Settings, or System Attribute]
	#TODO: scaling_factor   = [Replace With State, Settings, or System Attribute]
	#TODO: sears_haack_type = [Replace With State, Settings, or System Attribute]

	results = func_wave_drag_volume_sears_haack('vehicle', 'mach', 'scaling_factor', 'sears_haack_type')
