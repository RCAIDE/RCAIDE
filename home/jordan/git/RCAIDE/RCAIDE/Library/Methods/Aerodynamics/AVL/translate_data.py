...
## @ingroup Methods-Aerodynamics-AVL
def func_translate_conditions_to_cases(avl ,conditions):
...
def func_translate_results_to_conditions(cases,results):
...
def translate_conditions_to_cases(State, Settings, System):
	#TODO: avl        = [Replace With State, Settings, or System Attribute]
	#TODO: conditions = [Replace With State, Settings, or System Attribute]

	results = func_translate_conditions_to_cases('avl', 'conditions')
...
def translate_results_to_conditions(State, Settings, System):
	#TODO: cases   = [Replace With State, Settings, or System Attribute]
	#TODO: results = [Replace With State, Settings, or System Attribute]

	results = func_translate_results_to_conditions('cases', 'results')
	#TODO: [Replace results with the output of the original function]
