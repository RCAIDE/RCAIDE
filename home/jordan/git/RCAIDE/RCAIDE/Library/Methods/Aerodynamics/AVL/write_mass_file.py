...
def func_write_mass_file(avl_object,run_conditions):
...
def write_mass_file(State, Settings, System):
	#TODO: avl_object     = [Replace With State, Settings, or System Attribute]
	#TODO: run_conditions = [Replace With State, Settings, or System Attribute]

	results = func_write_mass_file('avl_object', 'run_conditions')
