...
## @ingroup Methods-Aerodynamics-Airfoil_Panel_Method
def func_airfoil_analysis(airfoil_geometry,alpha,Re_L,initial_momentum_thickness=1E-5,tolerance = 1E0,H_wake = 1.05,Ue_wake = 0.99):
...
def func_concatenate_surfaces(X_BOT,X_TOP,FUNC_BOT_SURF,FUNC_TOP_SURF,npanel,ncases,ncpts): 
...
def airfoil_analysis(State, Settings, System):
	#TODO: airfoil_geometry           = [Replace With State, Settings, or System Attribute]
	#TODO: alpha                      = [Replace With State, Settings, or System Attribute]
	#TODO: Re_L                       = [Replace With State, Settings, or System Attribute]
	#TODO: initial_momentum_thickness = [Replace With State, Settings, or System Attribute]
	#TODO: tolerance                  = [Replace With State, Settings, or System Attribute]
	#TODO: H_wake                     = [Replace With State, Settings, or System Attribute]
	#TODO: Ue_wake                    = [Replace With State, Settings, or System Attribute]

	results = func_airfoil_analysis('airfoil_geometry', 'alpha', 'Re_L', 'initial_momentum_thickness', 'tolerance', 'H_wake', 'Ue_wake')
...
def concatenate_surfaces(State, Settings, System):
	#TODO: X_BOT         = [Replace With State, Settings, or System Attribute]
	#TODO: X_TOP         = [Replace With State, Settings, or System Attribute]
	#TODO: FUNC_BOT_SURF = [Replace With State, Settings, or System Attribute]
	#TODO: FUNC_TOP_SURF = [Replace With State, Settings, or System Attribute]
	...
	results = func_concatenate_surfaces('X_BOT', 'X_TOP', 'FUNC_BOT_SURF', 'FUNC_TOP_SURF', 'npanel', 'ncases', 'ncpts')
	#TODO: [Replace results with the output of the original function]
