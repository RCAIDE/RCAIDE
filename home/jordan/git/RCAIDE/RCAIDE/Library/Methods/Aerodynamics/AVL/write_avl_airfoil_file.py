...
def func_write_avl_airfoil_file(suave_airfoil_filename):
...
def write_avl_airfoil_file(State, Settings, System):
	#TODO: suave_airfoil_filename = [Replace With State, Settings, or System Attribute]

	results = func_write_avl_airfoil_file('suave_airfoil_filename',)
