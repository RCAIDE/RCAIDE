...
## @ingroup Methods-Aerodynamics-AVL
def func_write_geometry(avl_object,run_script_path):
...
def func_make_header_text(avl_object):  
...
def func_make_surface_text(avl_wing,number_spanwise_vortices,number_chordwise_vortices):
...
def func_make_body_text(avl_body,number_chordwise_vortices):   
...
def func_make_wing_section_text(avl_section):
...
def func_make_body_section_text(avl_body_section):
    """This function writes the body text using the template required for the AVL executable to read
...
def func_make_controls_text(avl_control_surface):
...
def write_geometry(State, Settings, System):
	#TODO: avl_object      = [Replace With State, Settings, or System Attribute]
	#TODO: run_script_path = [Replace With State, Settings, or System Attribute]

	results = func_write_geometry('avl_object', 'run_script_path')
...
def make_header_text(State, Settings, System):
	#TODO: avl_object = [Replace With State, Settings, or System Attribute]

	results = func_make_header_text('avl_object',)
	#TODO: [Replace results with the output of the original function]
...
def make_surface_text(State, Settings, System):
	#TODO: avl_wing                  = [Replace With State, Settings, or System Attribute]
	#TODO: number_spanwise_vortices  = [Replace With State, Settings, or System Attribute]
	#TODO: number_chordwise_vortices = [Replace With State, Settings, or System Attribute]

	results = func_make_surface_text('avl_wing', 'number_spanwise_vortices', 'number_chordwise_vortices')
	#TODO: [Replace results with the output of the original function]
...
def make_body_text(State, Settings, System):
	#TODO: avl_body                  = [Replace With State, Settings, or System Attribute]
	#TODO: number_chordwise_vortices = [Replace With State, Settings, or System Attribute]

	results = func_make_body_text('avl_body', 'number_chordwise_vortices')
	#TODO: [Replace results with the output of the original function]
...
def make_wing_section_text(State, Settings, System):
	#TODO: avl_section = [Replace With State, Settings, or System Attribute]

	results = func_make_wing_section_text('avl_section',)
	#TODO: [Replace results with the output of the original function]
...
def make_body_section_text(State, Settings, System):
	#TODO: avl_body_section = [Replace With State, Settings, or System Attribute]

	results = func_make_body_section_text('avl_body_section',)
	#TODO: [Replace results with the output of the original function]
...
def make_controls_text(State, Settings, System):
	#TODO: avl_control_surface = [Replace With State, Settings, or System Attribute]

	results = func_make_controls_text('avl_control_surface',)
	#TODO: [Replace results with the output of the original function]
