...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_payload_FLOPS(vehicle, weight_per_passenger = 165. * Units.lb):
...
def payload_FLOPS(State, Settings, System):
	#TODO: vehicle              = [Replace With State, Settings, or System Attribute]
	#TODO: weight_per_passenger = [Replace With State, Settings, or System Attribute]

	results = func_payload_FLOPS('vehicle', 'weight_per_passenger')
