...
# ----------------------------------------------------------------------
## @ingroup Methods-Weights-Correlations-General_Aviation
def func_tail_vertical(S_v, AR_v, sweep_v, q_c, taper_v, t_c_v, Nult,TOW,t_tail, rudder_fraction = 0.25):      
    """
...
def tail_vertical(State, Settings, System):
	#TODO: S_v             = [Replace With State, Settings, or System Attribute]
	#TODO: AR_v            = [Replace With State, Settings, or System Attribute]
	#TODO: sweep_v         = [Replace With State, Settings, or System Attribute]
	#TODO: q_c             = [Replace With State, Settings, or System Attribute]
	#TODO: taper_v         = [Replace With State, Settings, or System Attribute]
	#TODO: t_c_v           = [Replace With State, Settings, or System Attribute]
	#TODO: Nult            = [Replace With State, Settings, or System Attribute]
	#TODO: TOW             = [Replace With State, Settings, or System Attribute]
	#TODO: t_tail          = [Replace With State, Settings, or System Attribute]
	#TODO: rudder_fraction = [Replace With State, Settings, or System Attribute]

	results = func_tail_vertical('S_v', 'AR_v', 'sweep_v', 'q_c', 'taper_v', 't_c_v', 'Nult', 'TOW', 't_tail', 'rudder_fraction')
