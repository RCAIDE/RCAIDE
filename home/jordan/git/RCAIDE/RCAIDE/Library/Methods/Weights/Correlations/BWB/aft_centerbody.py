...
## @ingroup Methods-Weights-Correlations-BWB
def func_aft_centerbody(no_of_engines, aft_centerbody_area, aft_centerbody_taper, TOGW):
...
def aft_centerbody(State, Settings, System):
	#TODO: no_of_engines        = [Replace With State, Settings, or System Attribute]
	#TODO: aft_centerbody_area  = [Replace With State, Settings, or System Attribute]
	#TODO: aft_centerbody_taper = [Replace With State, Settings, or System Attribute]
	#TODO: TOGW                 = [Replace With State, Settings, or System Attribute]

	results = func_aft_centerbody('no_of_engines', 'aft_centerbody_area', 'aft_centerbody_taper', 'TOGW')
