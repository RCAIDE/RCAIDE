...
## @ingroup Methods-Weights-Correlations-Human_Powered
def func_wing(Sw,bw,cw,Nwr,t_cw,Nwer,nult,GW):
...
def wing(State, Settings, System):
	...
	#TODO: Nwr  = [Replace With State, Settings, or System Attribute]
	#TODO: t_cw = [Replace With State, Settings, or System Attribute]
	#TODO: Nwer = [Replace With State, Settings, or System Attribute]
	#TODO: nult = [Replace With State, Settings, or System Attribute]
	#TODO: GW   = [Replace With State, Settings, or System Attribute]

	results = func_wing('Sw', 'bw', 'cw', 'Nwr', 't_cw', 'Nwer', 'nult', 'GW')
