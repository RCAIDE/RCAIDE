...
## @ingroup Methods-Weights-Correlations-Raymer
def func_total_prop_Raymer(vehicle,prop):
...
## @ingroup Methods-Weights-Correlations-Raymer
def func_nacelle_Raymer(vehicle, WENG):
...
## @ingroup Methods-Weights-Correlations-Raymer
def func_misc_engine_Raymer(vehicle, prop, WENG):
...
## @ingroup Methods-Weights-Correlations-Raymer
def func_fuel_system_Raymer(vehicle, NENG):
...
def nacelle_Raymer(State, Settings, System):
	#TODO: vehicle = [Replace With State, Settings, or System Attribute]
	#TODO: WENG    = [Replace With State, Settings, or System Attribute]

	results = func_nacelle_Raymer('vehicle', 'WENG')
	#TODO: [Replace results with the output of the original function]
...
def misc_engine_Raymer(State, Settings, System):
	#TODO: vehicle = [Replace With State, Settings, or System Attribute]
	#TODO: prop    = [Replace With State, Settings, or System Attribute]
	#TODO: WENG    = [Replace With State, Settings, or System Attribute]

	results = func_misc_engine_Raymer('vehicle', 'prop', 'WENG')
	#TODO: [Replace results with the output of the original function]
...
def fuel_system_Raymer(State, Settings, System):
	#TODO: vehicle = [Replace With State, Settings, or System Attribute]
	#TODO: NENG    = [Replace With State, Settings, or System Attribute]

	results = func_fuel_system_Raymer('vehicle', 'NENG')
	#TODO: [Replace results with the output of the original function]
