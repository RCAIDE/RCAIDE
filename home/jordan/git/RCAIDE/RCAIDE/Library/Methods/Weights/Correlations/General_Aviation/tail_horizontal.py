...
# ----------------------------------------------------------------------
## @ingroup Methods-Weights-Correlations-General_Aviation
def func_tail_horizontal(S_h, AR_h, sweep_h, q_c, taper_h, t_c_h,Nult,TOW):       
    """ 
...
def tail_horizontal(State, Settings, System):
	#TODO: S_h     = [Replace With State, Settings, or System Attribute]
	#TODO: AR_h    = [Replace With State, Settings, or System Attribute]
	#TODO: sweep_h = [Replace With State, Settings, or System Attribute]
	#TODO: q_c     = [Replace With State, Settings, or System Attribute]
	#TODO: taper_h = [Replace With State, Settings, or System Attribute]
	#TODO: t_c_h   = [Replace With State, Settings, or System Attribute]
	#TODO: Nult    = [Replace With State, Settings, or System Attribute]
	#TODO: TOW     = [Replace With State, Settings, or System Attribute]

	results = func_tail_horizontal('S_h', 'AR_h', 'sweep_h', 'q_c', 'taper_h', 't_c_h', 'Nult', 'TOW')
