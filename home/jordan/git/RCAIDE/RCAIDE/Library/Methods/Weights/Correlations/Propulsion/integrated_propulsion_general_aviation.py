...
# ----------------------------------------------------------------------
## @ingroup Methods-Weights-Correlations-Propulsion
def func_integrated_propulsion_general_aviation(engine_piston,num_eng, engine_wt_factor = 2.575, engine_wt_exp = .922):
    """ 
...
def integrated_propulsion_general_aviation(State, Settings, System):
	#TODO: engine_piston    = [Replace With State, Settings, or System Attribute]
	#TODO: num_eng          = [Replace With State, Settings, or System Attribute]
	#TODO: engine_wt_factor = [Replace With State, Settings, or System Attribute]
	#TODO: engine_wt_exp    = [Replace With State, Settings, or System Attribute]

	results = func_integrated_propulsion_general_aviation('engine_piston', 'num_eng', 'engine_wt_factor', 'engine_wt_exp')
