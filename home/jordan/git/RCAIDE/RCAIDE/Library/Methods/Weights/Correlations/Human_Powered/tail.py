...
## @ingroup Methods-Weights-Correlations-Human_Powered
def func_tail(Sts,bts,cts,Ntsr,t_cts,qm):        
...
def tail(State, Settings, System):
	#TODO: Sts   = [Replace With State, Settings, or System Attribute]
	#TODO: bts   = [Replace With State, Settings, or System Attribute]
	#TODO: cts   = [Replace With State, Settings, or System Attribute]
	#TODO: Ntsr  = [Replace With State, Settings, or System Attribute]
	#TODO: t_cts = [Replace With State, Settings, or System Attribute]
	#TODO: qm    = [Replace With State, Settings, or System Attribute]

	results = func_tail('Sts', 'bts', 'cts', 'Ntsr', 't_cts', 'qm')
