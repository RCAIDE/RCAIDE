...
# ----------------------------------------------------------------------
## @ingroup Methods-Weights-Correlations-General_Aviation
def func_systems(W_uav, V_fuel, V_int, N_tank, N_eng, l_fuselage, span, TOW, Nult, num_seats,  mach_number, has_air_conditioner=1):
...
def systems(State, Settings, System):
	#TODO: W_uav               = [Replace With State, Settings, or System Attribute]
	#TODO: V_fuel              = [Replace With State, Settings, or System Attribute]
	#TODO: V_int               = [Replace With State, Settings, or System Attribute]
	#TODO: N_tank              = [Replace With State, Settings, or System Attribute]
	#TODO: N_eng               = [Replace With State, Settings, or System Attribute]
	#TODO: l_fuselage          = [Replace With State, Settings, or System Attribute]
	...
	#TODO: num_seats           = [Replace With State, Settings, or System Attribute]
	#TODO: mach_number         = [Replace With State, Settings, or System Attribute]
	#TODO: has_air_conditioner = [Replace With State, Settings, or System Attribute]

	results = func_systems('W_uav', 'V_fuel', 'V_int', 'N_tank', 'N_eng', 'l_fuselage', 'span', 'TOW', 'Nult', 'num_seats', 'mach_number', 'has_air_conditioner')
