...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_total_prop_flops(vehicle,prop):
...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_nacelle_FLOPS(prop,nacelle):
...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_thrust_reverser_FLOPS(prop):
...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_misc_engine_FLOPS(vehicle,prop,nacelle):
...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_fuel_system_FLOPS(vehicle, NENG):
...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_engine_FLOPS(vehicle, prop):
...
def nacelle_FLOPS(State, Settings, System):
	#TODO: prop    = [Replace With State, Settings, or System Attribute]
	#TODO: nacelle = [Replace With State, Settings, or System Attribute]

	results = func_nacelle_FLOPS('prop', 'nacelle')
	#TODO: [Replace results with the output of the original function]
...
def thrust_reverser_FLOPS(State, Settings, System):
	#TODO: prop = [Replace With State, Settings, or System Attribute]

	results = func_thrust_reverser_FLOPS('prop',)
	#TODO: [Replace results with the output of the original function]
...
def misc_engine_FLOPS(State, Settings, System):
	#TODO: vehicle = [Replace With State, Settings, or System Attribute]
	#TODO: prop    = [Replace With State, Settings, or System Attribute]
	#TODO: nacelle = [Replace With State, Settings, or System Attribute]

	results = func_misc_engine_FLOPS('vehicle', 'prop', 'nacelle')
	#TODO: [Replace results with the output of the original function]
...
def fuel_system_FLOPS(State, Settings, System):
	#TODO: vehicle = [Replace With State, Settings, or System Attribute]
	#TODO: NENG    = [Replace With State, Settings, or System Attribute]

	results = func_fuel_system_FLOPS('vehicle', 'NENG')
	#TODO: [Replace results with the output of the original function]
...
def engine_FLOPS(State, Settings, System):
	#TODO: vehicle = [Replace With State, Settings, or System Attribute]
	#TODO: prop    = [Replace With State, Settings, or System Attribute]

	results = func_engine_FLOPS('vehicle', 'prop')
	#TODO: [Replace results with the output of the original function]
