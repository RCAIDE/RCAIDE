...
def wing(State, Settings, System):
	...
	results = func_wing('wing', 'config', 'max_thrust', 'num_analysis_points', 'safety_factor', 'max_g_load', 'moment_to_lift_ratio', 'lift_to_drag_ratio', 'forward_web_locations', 'rear_web_locations', 'shear_center_location', 'margin_factor')
