...
def empty(State, Settings, System):
	...
	results = func_empty('config', 'settings', 'contingency_factor', 'speed_of_sound', 'max_tip_mach', 'disk_area_factor', 'safety_factor', 'max_thrust_to_weight_ratio', 'max_g_load', 'motor_efficiency')
