...
## @ingroup Methods-Noise-Fidelity_One-Noise_Tools 
def func_SPL_harmonic_to_third_octave(SPL,f,settings): 
...
def SPL_harmonic_to_third_octave(State, Settings, System):
	...
	results = func_SPL_harmonic_to_third_octave('SPL', 'f', 'settings')
