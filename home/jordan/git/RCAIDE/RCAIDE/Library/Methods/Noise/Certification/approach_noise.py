...
## @ingroup Methods-Noise-Certification 
def func_approach_noise(analyses,noise_configs):  
...
def approach_noise(State, Settings, System):
	#TODO: analyses      = [Replace With State, Settings, or System Attribute]
	#TODO: noise_configs = [Replace With State, Settings, or System Attribute]

	results = func_approach_noise('analyses', 'noise_configs')
