...
## @ingroup Methods-Noise-Fidelity_One-Noise_Tools
def func_noise_geometric(noise_segment,analyses,config):
...
def noise_geometric(State, Settings, System):
	...
	results = func_noise_geometric('noise_segment', 'analyses', 'config')
