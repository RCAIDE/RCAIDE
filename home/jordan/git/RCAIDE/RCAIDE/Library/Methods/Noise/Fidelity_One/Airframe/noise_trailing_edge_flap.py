...
## @ingroup Methods-Noise-Fidelity_One-Airframe
def func_noise_trailing_edge_flap(Sf,cf,deltaf,slots,velocity,M,phi,theta,distance,frequency):
...
def noise_trailing_edge_flap(State, Settings, System):
	...
	results = func_noise_trailing_edge_flap('Sf', 'cf', 'deltaf', 'slots', 'velocity', 'M', 'phi', 'theta', 'distance', 'frequency')
