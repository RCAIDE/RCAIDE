...
## @ingroup Methods-Noise-Fidelity_One-Engine
def func_noise_SAE(turbofan,segment,analyses,config,settings,ioprint = 0, filename = 0):  
...
def noise_SAE(State, Settings, System):
	...
	results = func_noise_SAE('turbofan', 'segment', 'analyses', 'config', 'settings', 'ioprint', 'filename')
