...
## @ingroup Methods-Noise-Fidelity_One-Engine
def func_mixed_noise_component(SPL_m,Velocity_primary,theta_m,sound_ambient,Velocity_secondary,
...
def mixed_noise_component(State, Settings, System):
	#TODO: SPL_m              = [Replace With State, Settings, or System Attribute]
	...
	results = func_mixed_noise_component('SPL_m', 'Velocity_primary', 'theta_m', 'sound_ambient', 'Velocity_secondary', 'Velocity_aircraft', 'Area_primary', 'Area_secondary', 'DSPL_m', 'EX_m', 'Str_m', 'Velocity_mixed', 'XBPR')
