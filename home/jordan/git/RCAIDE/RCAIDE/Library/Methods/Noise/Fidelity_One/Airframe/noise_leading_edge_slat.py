...
## @ingroup Methods-Noise-Fidelity_One-Airframe
def func_noise_leading_edge_slat(SPL_wing,Sw,bw,velocity,viscosity,M,phi,theta,distance,frequency):
...
def noise_leading_edge_slat(State, Settings, System):
	...
	results = func_noise_leading_edge_slat('SPL_wing', 'Sw', 'bw', 'velocity', 'viscosity', 'M', 'phi', 'theta', 'distance', 'frequency')
