...
## @ingroup Methods-Noise-Fidelity_One-Engine
def func_angle_of_attack_effect (AoA,Mach_aircraft,theta_m):
...
def angle_of_attack_effect(State, Settings, System):
	...
	results = func_angle_of_attack_effect('AoA', 'Mach_aircraft', 'theta_m')
