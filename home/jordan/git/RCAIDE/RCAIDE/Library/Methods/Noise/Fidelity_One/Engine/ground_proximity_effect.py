...
## @ingroup Methods-Noise-Fidelity_One-Engine
def func_ground_proximity_effect (Velocity_mixed,sound_ambient,theta_m,engine_height,Diameter_mixed,frequency):
...
def ground_proximity_effect(State, Settings, System):
	...
	results = func_ground_proximity_effect('Velocity_mixed', 'sound_ambient', 'theta_m', 'engine_height', 'Diameter_mixed', 'frequency')
