...
## @ingroup Methods-Noise-Fidelity_One-Airframe
def func_noise_clean_wing(S,b,ND,IsHorz,velocity,viscosity,M,phi,theta,distance,frequency):
...
def noise_clean_wing(State, Settings, System):
	...
	results = func_noise_clean_wing('S', 'b', 'ND', 'IsHorz', 'velocity', 'viscosity', 'M', 'phi', 'theta', 'distance', 'frequency')
