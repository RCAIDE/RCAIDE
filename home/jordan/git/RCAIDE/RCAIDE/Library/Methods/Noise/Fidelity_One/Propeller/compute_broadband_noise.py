...
## @ingroup Methods-Noise-Fidelity_One-Propeller   
def func_compute_broadband_noise(freestream,angle_of_attack,bspv,
...
def compute_broadband_noise(State, Settings, System):
	...
	#TODO: bspv              = [Replace With State, Settings, or System Attribute]
	...
	results = func_compute_broadband_noise('freestream', 'angle_of_attack', 'bspv', 'velocity_vector', 'rotors', 'aeroacoustic_data', 'settings', 'res')
