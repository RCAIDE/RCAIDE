...
# -------------------------------------------------------------------------------------
## @ingroup Methods-Noise-Fidelity_One-Propeller
def func_propeller_mid_fidelity(rotors,aeroacoustic_data,segment,settings):
...
def propeller_mid_fidelity(State, Settings, System):
	...
	results = func_propeller_mid_fidelity('rotors', 'aeroacoustic_data', 'segment', 'settings')
