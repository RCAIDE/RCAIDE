...
## @ingroup Methods-Noise-Fidelity_One-Engine
def func_secondary_noise_component(SPL_s,Velocity_primary,theta_s,sound_ambient,Velocity_secondary,Velocity_aircraft,
...
def secondary_noise_component(State, Settings, System):
	#TODO: SPL_s              = [Replace With State, Settings, or System Attribute]
	...
	results = func_secondary_noise_component('SPL_s', 'Velocity_primary', 'theta_s', 'sound_ambient', 'Velocity_secondary', 'Velocity_aircraft', 'Area_primary', 'Area_secondary', 'DSPL_s', 'EX_s', 'Str_s')
