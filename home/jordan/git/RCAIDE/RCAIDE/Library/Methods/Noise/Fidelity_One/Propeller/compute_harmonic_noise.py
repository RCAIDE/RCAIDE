...
# ----------------------------------------------------------------------
## @ingroup Methods-Noise-Fidelity_One-Propeller
def func_compute_harmonic_noise(harmonics,freestream,angle_of_attack,position_vector,
...
def compute_harmonic_noise(State, Settings, System):
	...
	#TODO: position_vector   = [Replace With State, Settings, or System Attribute]
	...
	results = func_compute_harmonic_noise('harmonics', 'freestream', 'angle_of_attack', 'position_vector', 'velocity_vector', 'rotors', 'aeroacoustic_data', 'settings', 'res')
