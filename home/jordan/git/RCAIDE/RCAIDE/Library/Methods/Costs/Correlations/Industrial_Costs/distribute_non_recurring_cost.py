...
# ----------------------------------------------------------------------
## @ingroup Methods-Costs-Industrial_Costs
def func_distribute_non_recurring_cost(costs):
...
def distribute_non_recurring_cost(State, Settings, System):
	#TODO: costs = [Replace With State, Settings, or System Attribute]

	results = func_distribute_non_recurring_cost('costs',)
