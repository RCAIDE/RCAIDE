...
# ----------------------------------------------------------------------
## @ingroup Methods-Power-Battery 
def func_pack_battery_conditions(conditions,battery,avionics_payload_power,P): 
...
def pack_battery_conditions(State, Settings, System):
	...
	#TODO: avionics_payload_power = [Replace With State, Settings, or System Attribute]
	#TODO: P                      = [Replace With State, Settings, or System Attribute]

	results = func_pack_battery_conditions('conditions', 'battery', 'avionics_payload_power', 'P')
