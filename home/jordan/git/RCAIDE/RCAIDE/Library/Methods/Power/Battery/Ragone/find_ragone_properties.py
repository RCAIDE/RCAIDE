...
## @ingroup Methods-Power-Battery-Ragone
def func_find_ragone_properties(specific_energy, battery, energy, power):
...
def find_ragone_properties(State, Settings, System):
	...
	results = func_find_ragone_properties('specific_energy', 'battery', 'energy', 'power')
