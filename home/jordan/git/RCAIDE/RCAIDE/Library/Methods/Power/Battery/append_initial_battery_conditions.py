...
# ----------------------------------------------------------------------
## @ingroup Methods-Power-Battery 
def func_append_initial_battery_conditions(segment,battery): 
...
def append_initial_battery_conditions(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]
	#TODO: battery = [Replace With State, Settings, or System Attribute]

	results = func_append_initial_battery_conditions('segment', 'battery')
