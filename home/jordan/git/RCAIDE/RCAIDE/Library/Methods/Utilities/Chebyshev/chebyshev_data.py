...
## @ingroup Methods-Utilities-Chebyshev
def func_chebyshev_data(N = 16, integration = True, **options):
...
def chebyshev_data(State, Settings, System):
	#TODO: N           = [Replace With State, Settings, or System Attribute]
	#TODO: integration = [Replace With State, Settings, or System Attribute]

	results = func_chebyshev_data('N', 'integration')
...
def func(State, Settings, System):
