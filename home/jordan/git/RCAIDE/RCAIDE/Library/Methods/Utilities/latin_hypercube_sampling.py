...
# ----------------------------------------------------------------------
## @ingroup Methods-Utilities
def func_latin_hypercube_sampling(num_dimensions,num_samples,bounds=None,criterion='random'):
...
def latin_hypercube_sampling(State, Settings, System):
	#TODO: num_dimensions = [Replace With State, Settings, or System Attribute]
	#TODO: num_samples    = [Replace With State, Settings, or System Attribute]
	#TODO: bounds         = [Replace With State, Settings, or System Attribute]
	#TODO: criterion      = [Replace With State, Settings, or System Attribute]

	results = func_latin_hypercube_sampling('num_dimensions', 'num_samples', 'bounds', 'criterion')
