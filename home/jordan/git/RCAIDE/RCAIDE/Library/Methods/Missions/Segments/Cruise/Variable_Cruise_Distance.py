...
# --------------------------------------------------------------
## @ingroup Methods-Missions-Segments-Cruise
def func_initialize_cruise_distance(segment):
...
## @ingroup Methods-Missions-Segments-Cruise
def func_unknown_cruise_distance(segment):
    """This is a method that allows your vehicle to land at prescribed landing weight
...
## @ingroup Methods-Missions-Segments-Cruise
def func_residual_landing_weight(segment):
    """This is a method that allows your vehicle to land at prescribed landing weight.
...
## @ingroup Methods-Missions-Segments-Cruise
def func_residual_state_of_charge(segment):
...
def initialize_cruise_distance(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_initialize_cruise_distance('segment',)
...
def unknown_cruise_distance(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_unknown_cruise_distance('segment',)
	#TODO: [Replace results with the output of the original function]
...
def residual_landing_weight(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_residual_landing_weight('segment',)
	#TODO: [Replace results with the output of the original function]
...
def residual_state_of_charge(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_residual_state_of_charge('segment',)
	#TODO: [Replace results with the output of the original function]
