...
## @ingroup Methods-Missions-Segments
def func_converge_root(segment):
...
## @ingroup Methods-Missions-Segments
def func_iterate(unknowns, segment):
...
def converge_root(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_converge_root('segment',)
...
def iterate(State, Settings, System):
	#TODO: unknowns = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = func_iterate('unknowns', 'segment')
	#TODO: [Replace results with the output of the original function]
