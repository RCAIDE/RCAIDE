...
## @ingroup Methods-Missions-Segments
def func_get_objective(unknowns, segment):
...
## @ingroup Methods-Missions-Segments
def func_get_econstraints(unknowns, segment):
...
## @ingroup Methods-Missions-Segments
def func_make_bnds(unknowns, segment):
...
## @ingroup Methods-Missions-Segments
def func_get_ieconstraints(unknowns, segment):
...
## @ingroup Methods-Missions-Segments
def func_get_problem_pyopt(unknowns, segment):
...
def converge_opt(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_converge_opt('segment',)
...
def get_objective(State, Settings, System):
	#TODO: unknowns = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = func_get_objective('unknowns', 'segment')
	#TODO: [Replace results with the output of the original function]
...
def get_econstraints(State, Settings, System):
	#TODO: unknowns = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = func_get_econstraints('unknowns', 'segment')
	#TODO: [Replace results with the output of the original function]
...
def make_bnds(State, Settings, System):
	#TODO: unknowns = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = func_make_bnds('unknowns', 'segment')
	#TODO: [Replace results with the output of the original function]
...
def get_ieconstraints(State, Settings, System):
	#TODO: unknowns = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = func_get_ieconstraints('unknowns', 'segment')
	#TODO: [Replace results with the output of the original function]
...
def get_problem_pyopt(State, Settings, System):
	#TODO: unknowns = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = func_get_problem_pyopt('unknowns', 'segment')
	#TODO: [Replace results with the output of the original function]
