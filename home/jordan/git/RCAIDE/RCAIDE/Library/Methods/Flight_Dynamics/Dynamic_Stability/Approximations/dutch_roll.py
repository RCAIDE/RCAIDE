...
## @ingroup Methods-Flight_Dynamics-Dynamic_Stability-Approximations
def func_dutch_roll(velocity, Cn_Beta, S_gross_w, density, span, I_z, Cn_r):
...
def dutch_roll(State, Settings, System):
	...
	results = func_dutch_roll('velocity', 'Cn_Beta', 'S_gross_w', 'density', 'span', 'I_z', 'Cn_r')
