...
## @ingroup Methods-Flight_Dynamics-Dynamic_Stability-Full_Linearized_Equations
def func_lateral_directional(velocity, Cn_Beta, S_gross_w, density, span, I_z, Cn_r, I_x, Cl_p, J_xz, Cl_r, Cl_Beta, Cn_p, Cy_phi, Cy_psi, Cy_Beta, mass):
...
def lateral_directional(State, Settings, System):
	#TODO: velocity  = [Replace With State, Settings, or System Attribute]
	#TODO: Cn_Beta   = [Replace With State, Settings, or System Attribute]
	...
	#TODO: I_z       = [Replace With State, Settings, or System Attribute]
	#TODO: Cn_r      = [Replace With State, Settings, or System Attribute]
	#TODO: I_x       = [Replace With State, Settings, or System Attribute]
	#TODO: Cl_p      = [Replace With State, Settings, or System Attribute]
	#TODO: J_xz      = [Replace With State, Settings, or System Attribute]
	#TODO: Cl_r      = [Replace With State, Settings, or System Attribute]
	#TODO: Cl_Beta   = [Replace With State, Settings, or System Attribute]
	#TODO: Cn_p      = [Replace With State, Settings, or System Attribute]
	#TODO: Cy_phi    = [Replace With State, Settings, or System Attribute]
	#TODO: Cy_psi    = [Replace With State, Settings, or System Attribute]
	#TODO: Cy_Beta   = [Replace With State, Settings, or System Attribute]
	#TODO: mass      = [Replace With State, Settings, or System Attribute]

	results = func_lateral_directional('velocity', 'Cn_Beta', 'S_gross_w', 'density', 'span', 'I_z', 'Cn_r', 'I_x', 'Cl_p', 'J_xz', 'Cl_r', 'Cl_Beta', 'Cn_p', 'Cy_phi', 'Cy_psi', 'Cy_Beta', 'mass')
