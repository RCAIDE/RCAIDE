...
## @ingroup Methods-Flight_Dynamics-Static_Stability
def func_compute_aero_derivatives(segment): 
...
def func_propeller_derivatives(segment, perturbed_segment, n_cpts):
...
def compute_aero_derivatives(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_compute_aero_derivatives('segment',)
...
def propeller_derivatives(State, Settings, System):
	#TODO: segment           = [Replace With State, Settings, or System Attribute]
	#TODO: perturbed_segment = [Replace With State, Settings, or System Attribute]
	#TODO: n_cpts            = [Replace With State, Settings, or System Attribute]

	results = func_propeller_derivatives('segment', 'perturbed_segment', 'n_cpts')
	#TODO: [Replace results with the output of the original function]
