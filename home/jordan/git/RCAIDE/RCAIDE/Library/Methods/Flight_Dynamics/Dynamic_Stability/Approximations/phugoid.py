...
## @ingroup Methods-Flight_Dynamics-Dynamic_Stability-Approximations
def func_phugoid(g, velocity, CD, CL):
...
def phugoid(State, Settings, System):
	#TODO: g        = [Replace With State, Settings, or System Attribute]
	...
	results = func_phugoid('g', 'velocity', 'CD', 'CL')
