...
## @ingroup Methods-Flight_Dynamics-Dynamic_Stability-Full_Linearized_Equations
def func_longitudinal(velocity, density, S_gross_w, mac, Cm_q, Cz_alpha, mass, Cm_alpha, Iy, Cm_alpha_dot, Cz_u, Cz_alpha_dot, Cz_q, Cw, Theta, Cx_u, Cx_alpha):
...
def longitudinal(State, Settings, System):
	...
	#TODO: Cz_u         = [Replace With State, Settings, or System Attribute]
	#TODO: Cz_alpha_dot = [Replace With State, Settings, or System Attribute]
	#TODO: Cz_q         = [Replace With State, Settings, or System Attribute]
	#TODO: Cw           = [Replace With State, Settings, or System Attribute]
	#TODO: Theta        = [Replace With State, Settings, or System Attribute]
	#TODO: Cx_u         = [Replace With State, Settings, or System Attribute]
	#TODO: Cx_alpha     = [Replace With State, Settings, or System Attribute]

	results = func_longitudinal('velocity', 'density', 'S_gross_w', 'mac', 'Cm_q', 'Cz_alpha', 'mass', 'Cm_alpha', 'Iy', 'Cm_alpha_dot', 'Cz_u', 'Cz_alpha_dot', 'Cz_q', 'Cw', 'Theta', 'Cx_u', 'Cx_alpha')
