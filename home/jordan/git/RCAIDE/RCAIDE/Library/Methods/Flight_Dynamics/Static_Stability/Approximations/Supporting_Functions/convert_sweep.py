...
## @ingroup Methods-Flight_Dynamics-Static_Stability-Approximations-Supporting_Functions
def func_convert_sweep(wing,old_ref_chord_fraction = 0.0,new_ref_chord_fraction = 0.25):
...
## @ingroup Methods-Flight_Dynamics-Static_Stability-Approximations-Supporting_Functions
def func_convert_sweep_segments(old_sweep, seg_a, seg_b, wing, old_ref_chord_fraction=0.0, new_ref_chord_fraction=0.25):
...
def convert_sweep(State, Settings, System):
	...
	results = func_convert_sweep('wing', 'old_ref_chord_fraction', 'new_ref_chord_fraction')
...
def convert_sweep_segments(State, Settings, System):
	...
	results = func_convert_sweep_segments('old_sweep', 'seg_a', 'seg_b', 'wing', 'old_ref_chord_fraction', 'new_ref_chord_fraction')
	#TODO: [Replace results with the output of the original function]
