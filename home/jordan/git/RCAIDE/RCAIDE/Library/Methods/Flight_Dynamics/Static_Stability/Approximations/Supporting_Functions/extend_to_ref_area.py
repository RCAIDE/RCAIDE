...
## @ingroup Methods-Flight_Dynamics-Static_Stability-Approximations-Supporting_Functions
def func_extend_to_ref_area(surface):
...
def extend_to_ref_area(State, Settings, System):
	#TODO: surface = [Replace With State, Settings, or System Attribute]

	results = func_extend_to_ref_area('surface',)
