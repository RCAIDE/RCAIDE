...
## @ingroup Methods-Geometry-Two_Dimensional-Cross_Section-Airfoil
def func_import_airfoil_geometry(airfoil_geometry_file, npoints = 200,surface_interpolation = 'cubic'):
...
def import_airfoil_geometry(State, Settings, System):
	...
	#TODO: surface_interpolation = [Replace With State, Settings, or System Attribute]

	results = func_import_airfoil_geometry('airfoil_geometry_file', 'npoints', 'surface_interpolation')
