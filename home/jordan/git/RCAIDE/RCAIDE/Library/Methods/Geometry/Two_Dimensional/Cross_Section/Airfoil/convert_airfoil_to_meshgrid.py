...
## @ingroup Methods-Geometry-Two_Dimensional-Cross_Section-Airfoil
def func_convert_airfoil_to_meshgrid(airfoil_geometry, *args, **kwargs):
...
def convert_airfoil_to_meshgrid(State, Settings, System):
	#TODO: airfoil_geometry = [Replace With State, Settings, or System Attribute]

	results = func_convert_airfoil_to_meshgrid('airfoil_geometry',)
