...
## @ingroup Methods-Geometry-Three_Dimensional
def func_compute_span_location_from_chord_length(wing,chord_length):
...
def compute_span_location_from_chord_length(State, Settings, System):
	#TODO: wing         = [Replace With State, Settings, or System Attribute]
	#TODO: chord_length = [Replace With State, Settings, or System Attribute]

	results = func_compute_span_location_from_chord_length('wing', 'chord_length')
