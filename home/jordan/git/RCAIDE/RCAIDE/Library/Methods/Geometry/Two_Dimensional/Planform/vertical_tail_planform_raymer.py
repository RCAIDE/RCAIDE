...
# ----------------------------------------------------------------------
## @ingroup Methods-Geometry-Two_Dimensional-Cross_Section-Planform
def func_vertical_tail_planform_raymer(vertical_stabilizer, wing,  l_vt,c_vt):
...
def vertical_tail_planform_raymer(State, Settings, System):
	#TODO: vertical_stabilizer = [Replace With State, Settings, or System Attribute]
	#TODO: wing                = [Replace With State, Settings, or System Attribute]
	#TODO: l_vt                = [Replace With State, Settings, or System Attribute]
	#TODO: c_vt                = [Replace With State, Settings, or System Attribute]

	results = func_vertical_tail_planform_raymer('vertical_stabilizer', 'wing', 'l_vt', 'c_vt')
