...
def func_wing_segmented_planform(wing, overwrite_reference = False):
...
def func_segment_properties(wing,update_wet_areas=False,update_ref_areas=False):
...
# Segment centroid
def func_segment_centroid(le_sweep,seg_span,dx,dy,dz,taper,A,dihedral,root_chord,tip_chord):
...
def wing_segmented_planform(State, Settings, System):
	#TODO: wing                = [Replace With State, Settings, or System Attribute]
	#TODO: overwrite_reference = [Replace With State, Settings, or System Attribute]

	results = func_wing_segmented_planform('wing', 'overwrite_reference')
...
def segment_properties(State, Settings, System):
	#TODO: wing             = [Replace With State, Settings, or System Attribute]
	#TODO: update_wet_areas = [Replace With State, Settings, or System Attribute]
	#TODO: update_ref_areas = [Replace With State, Settings, or System Attribute]

	results = func_segment_properties('wing', 'update_wet_areas', 'update_ref_areas')
	#TODO: [Replace results with the output of the original function]
...
def segment_centroid(State, Settings, System):
	#TODO: le_sweep   = [Replace With State, Settings, or System Attribute]
	#TODO: seg_span   = [Replace With State, Settings, or System Attribute]
	#TODO: dx         = [Replace With State, Settings, or System Attribute]
	#TODO: dy         = [Replace With State, Settings, or System Attribute]
	#TODO: dz         = [Replace With State, Settings, or System Attribute]
	#TODO: taper      = [Replace With State, Settings, or System Attribute]
	#TODO: A          = [Replace With State, Settings, or System Attribute]
	#TODO: dihedral   = [Replace With State, Settings, or System Attribute]
	#TODO: root_chord = [Replace With State, Settings, or System Attribute]
	#TODO: tip_chord  = [Replace With State, Settings, or System Attribute]

	results = func_segment_centroid('le_sweep', 'seg_span', 'dx', 'dy', 'dz', 'taper', 'A', 'dihedral', 'root_chord', 'tip_chord')
	#TODO: [Replace results with the output of the original function]
