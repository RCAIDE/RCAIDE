...
# ----------------------------------------------------------------------
## @ingroup Methods-Propulsion
def func_scramjet_sizing(scramjet,mach_number = None, altitude = None, delta_isa = 0, conditions = None):  
...
def scramjet_sizing(State, Settings, System):
	#TODO: scramjet    = [Replace With State, Settings, or System Attribute]
	...
	results = func_scramjet_sizing('scramjet', 'mach_number', 'altitude', 'delta_isa', 'conditions')
