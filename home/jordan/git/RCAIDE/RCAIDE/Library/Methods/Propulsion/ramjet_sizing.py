...
# ----------------------------------------------------------------------
## @ingroup Methods-Propulsion
def func_ramjet_sizing(ramjet,mach_number = None, altitude = None, delta_isa = 0, conditions = None):  
...
def ramjet_sizing(State, Settings, System):
	#TODO: ramjet      = [Replace With State, Settings, or System Attribute]
	...
	results = func_ramjet_sizing('ramjet', 'mach_number', 'altitude', 'delta_isa', 'conditions')
