...
def func_turbofan_sizing(turbofan,mach_number = None, altitude = None, delta_isa = 0, conditions = None):  
...
def turbofan_sizing(State, Settings, System):
	...
	results = func_turbofan_sizing('turbofan', 'mach_number', 'altitude', 'delta_isa', 'conditions')
