...
## @defgroup Methods-Propulsion-Rotor_Wake-Fidelity_Zero
def func_compute_wake_contraction_matrix(prop,Nr,m,nts,X_pts,prop_outputs):
...
def compute_wake_contraction_matrix(State, Settings, System):
	...
	#TODO: nts          = [Replace With State, Settings, or System Attribute]
	#TODO: X_pts        = [Replace With State, Settings, or System Attribute]
	#TODO: prop_outputs = [Replace With State, Settings, or System Attribute]

	results = func_compute_wake_contraction_matrix('prop', 'Nr', 'm', 'nts', 'X_pts', 'prop_outputs')
