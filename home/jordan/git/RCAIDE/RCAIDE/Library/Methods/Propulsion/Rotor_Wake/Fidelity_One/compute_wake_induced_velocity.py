...
## @ingroup Methods-Propulsion-Rotor_Wake-Fidelity_One
def func_compute_wake_induced_velocity(WD,VD,cpts,azi_start_idx=0,sigma=0.11,suppress_root=False):  
...
# -------------------------------------------------------------------------------
## @ingroup Methods-Propulsion-Rotor_Wake-Fidelity_One
def func_vortex(X,Y,Z,X1,Y1,Z1,X2,Y2,Z2,sigma, GAMMA = 1, bv=False,WD=None,use_regularization_kernal=True):
...
def func_row_reduction_summation(A):
    # sum along last axis
...
## @ingroup Methods-Propulsion-Rotor_Wake-Fidelity_One
def func_regularization_kernel(COEF_in, sigma):
    """
...
def compute_wake_induced_velocity(State, Settings, System):
	#TODO: WD            = [Replace With State, Settings, or System Attribute]
	#TODO: VD            = [Replace With State, Settings, or System Attribute]
	#TODO: cpts          = [Replace With State, Settings, or System Attribute]
	#TODO: azi_start_idx = [Replace With State, Settings, or System Attribute]
	#TODO: sigma         = [Replace With State, Settings, or System Attribute]
	#TODO: suppress_root = [Replace With State, Settings, or System Attribute]

	results = func_compute_wake_induced_velocity('WD', 'VD', 'cpts', 'azi_start_idx', 'sigma', 'suppress_root')
...
def vortex(State, Settings, System):
	...
	#TODO: Z1                        = [Replace With State, Settings, or System Attribute]
	#TODO: X2                        = [Replace With State, Settings, or System Attribute]
	#TODO: Y2                        = [Replace With State, Settings, or System Attribute]
	#TODO: Z2                        = [Replace With State, Settings, or System Attribute]
	#TODO: sigma                     = [Replace With State, Settings, or System Attribute]
	#TODO: GAMMA                     = [Replace With State, Settings, or System Attribute]
	#TODO: bv                        = [Replace With State, Settings, or System Attribute]
	#TODO: WD                        = [Replace With State, Settings, or System Attribute]
	#TODO: use_regularization_kernal = [Replace With State, Settings, or System Attribute]

	results = func_vortex('X', 'Y', 'Z', 'X1', 'Y1', 'Z1', 'X2', 'Y2', 'Z2', 'sigma', 'GAMMA', 'bv', 'WD', 'use_regularization_kernal')
	#TODO: [Replace results with the output of the original function]
...
def row_reduction_summation(State, Settings, System):
	#TODO: A = [Replace With State, Settings, or System Attribute]

	results = func_row_reduction_summation('A',)
	#TODO: [Replace results with the output of the original function]
...
def regularization_kernel(State, Settings, System):
	#TODO: COEF_in = [Replace With State, Settings, or System Attribute]
	#TODO: sigma   = [Replace With State, Settings, or System Attribute]

	results = func_regularization_kernel('COEF_in', 'sigma')
	#TODO: [Replace results with the output of the original function]
