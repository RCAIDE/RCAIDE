...
## @ingroup Methods-Propulsion
def func_size_optimal_motor(motor,prop):
...
## @ingroup Methods-Propulsion
def func_optimize_kv(io, v , omeg,  etam ,  Q, kv_lower_bound =  0.01, Res_lower_bound = 0.001, kv_upper_bound = 100, Res_upper_bound = 10 ): 
...
def size_from_mass(State, Settings, System):
	#TODO: motor = [Replace With State, Settings, or System Attribute]

	results = func_size_from_mass('motor',)
	#TODO: [Replace results with the output of the original function]
...
def size_optimal_motor(State, Settings, System):
	#TODO: motor = [Replace With State, Settings, or System Attribute]
	#TODO: prop  = [Replace With State, Settings, or System Attribute]

	results = func_size_optimal_motor('motor', 'prop')
	#TODO: [Replace results with the output of the original function]
...
def optimize_kv(State, Settings, System):
	...
	results = func_optimize_kv('io', 'v', 'omeg', 'etam', 'Q', 'kv_lower_bound', 'Res_lower_bound', 'kv_upper_bound', 'Res_upper_bound')
	#TODO: [Replace results with the output of the original function]
...
def objective(State, Settings, System):
	...
	results = func_objective('x', 'v', 'omeg', 'etam', 'Q', 'io')
	#TODO: [Replace results with the output of the original function]
...
def hard_constraint_1(State, Settings, System):
	#TODO: x    = [Replace With State, Settings, or System Attribute]
	#TODO: v    = [Replace With State, Settings, or System Attribute]
	#TODO: omeg = [Replace With State, Settings, or System Attribute]
	#TODO: etam = [Replace With State, Settings, or System Attribute]
	...
	results = func_hard_constraint_1('x', 'v', 'omeg', 'etam', 'Q', 'io')
	#TODO: [Replace results with the output of the original function]
...
def hard_constraint_2(State, Settings, System):
	#TODO: x    = [Replace With State, Settings, or System Attribute]
	#TODO: v    = [Replace With State, Settings, or System Attribute]
	#TODO: omeg = [Replace With State, Settings, or System Attribute]
	#TODO: etam = [Replace With State, Settings, or System Attribute]
	...
	results = func_hard_constraint_2('x', 'v', 'omeg', 'etam', 'Q', 'io')
	#TODO: [Replace results with the output of the original function]
...
def slack_constraint_1(State, Settings, System):
	#TODO: x    = [Replace With State, Settings, or System Attribute]
	#TODO: v    = [Replace With State, Settings, or System Attribute]
	#TODO: omeg = [Replace With State, Settings, or System Attribute]
	#TODO: etam = [Replace With State, Settings, or System Attribute]
	...
	results = func_slack_constraint_1('x', 'v', 'omeg', 'etam', 'Q', 'io')
	#TODO: [Replace results with the output of the original function]
...
def slack_constraint_2(State, Settings, System):
	#TODO: x    = [Replace With State, Settings, or System Attribute]
	#TODO: v    = [Replace With State, Settings, or System Attribute]
	#TODO: omeg = [Replace With State, Settings, or System Attribute]
	#TODO: etam = [Replace With State, Settings, or System Attribute]
	...
	results = func_slack_constraint_2('x', 'v', 'omeg', 'etam', 'Q', 'io')
	#TODO: [Replace results with the output of the original function]
