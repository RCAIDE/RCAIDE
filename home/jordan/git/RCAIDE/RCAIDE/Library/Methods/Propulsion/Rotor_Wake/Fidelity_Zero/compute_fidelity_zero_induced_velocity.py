...
## @defgroup Methods-Propulsion-Rotor_Wake-Fidelity_Zero
def func_compute_fidelity_zero_induced_velocity(evaluation_points, props, ctrl_pts, identical_flag=False):  
...
def compute_fidelity_zero_induced_velocity(State, Settings, System):
	#TODO: evaluation_points = [Replace With State, Settings, or System Attribute]
	#TODO: props             = [Replace With State, Settings, or System Attribute]
	#TODO: ctrl_pts          = [Replace With State, Settings, or System Attribute]
	#TODO: identical_flag    = [Replace With State, Settings, or System Attribute]

	results = func_compute_fidelity_zero_induced_velocity('evaluation_points', 'props', 'ctrl_pts', 'identical_flag')
