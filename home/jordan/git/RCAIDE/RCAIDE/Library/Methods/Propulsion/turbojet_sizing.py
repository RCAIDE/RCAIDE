...
def func_turbojet_sizing(turbojet,mach_number = None, altitude = None, delta_isa = 0, conditions = None):  
...
def turbojet_sizing(State, Settings, System):
	#TODO: turbojet    = [Replace With State, Settings, or System Attribute]
	...
	results = func_turbojet_sizing('turbojet', 'mach_number', 'altitude', 'delta_isa', 'conditions')
