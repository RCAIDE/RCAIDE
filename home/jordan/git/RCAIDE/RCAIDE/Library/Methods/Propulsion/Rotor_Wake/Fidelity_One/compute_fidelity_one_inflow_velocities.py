...
## @ingroup Methods-Propulsion-Rotor_Wake-Fidelity_One
def func_compute_fidelity_one_inflow_velocities( wake, prop ):
    """
    Assumptions:
        None
...
def compute_fidelity_one_inflow_velocities(State, Settings, System):
	#TODO: wake = [Replace With State, Settings, or System Attribute]
	#TODO: prop = [Replace With State, Settings, or System Attribute]

	results = func_compute_fidelity_one_inflow_velocities('wake', 'prop')
