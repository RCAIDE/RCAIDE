...
## @ingroup Methods-Performance
def func_estimate_landing_field_length(vehicle,analyses,airport):
...
def estimate_landing_field_length(State, Settings, System):
	...
	results = func_estimate_landing_field_length('vehicle', 'analyses', 'airport')
