...
## @ingroup Methods-Performance
def func_payload_range(vehicle,mission,cruise_segment_tag,reserves=0.):
...
def payload_range(State, Settings, System):
	...
	#TODO: reserves           = [Replace With State, Settings, or System Attribute]

	results = func_payload_range('vehicle', 'mission', 'cruise_segment_tag', 'reserves')
