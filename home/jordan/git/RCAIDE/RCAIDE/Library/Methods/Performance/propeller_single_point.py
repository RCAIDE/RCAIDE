...
## @ingroup Methods-Performance
def func_propeller_single_point(prop,
                           pitch,
                           omega,
                           altitude,
                           delta_isa,
...
def propeller_single_point(State, Settings, System):
	...
	#TODO: plots         = [Replace With State, Settings, or System Attribute]
	#TODO: print_results = [Replace With State, Settings, or System Attribute]

	results = func_propeller_single_point('prop', 'pitch', 'omega', 'altitude', 'delta_isa', 'speed', 'analyses', 'plots', 'print_results')
