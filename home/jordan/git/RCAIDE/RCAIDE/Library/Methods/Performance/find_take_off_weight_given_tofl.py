...
## @ingroup Methods-Performance
def func_find_take_off_weight_given_tofl(vehicle,analyses,airport,target_tofl):
...
def find_take_off_weight_given_tofl(State, Settings, System):
	...
	#TODO: target_tofl = [Replace With State, Settings, or System Attribute]

	results = func_find_take_off_weight_given_tofl('vehicle', 'analyses', 'airport', 'target_tofl')
