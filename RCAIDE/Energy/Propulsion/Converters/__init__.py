## @defgroup Energy-Propulsion-Converters Converters
# RCAIDE/Energy/Propulsion/Converters/__init__.py
...
from Legacy.trunk.S.Components.Energy.Converters import Lift_Rotor
