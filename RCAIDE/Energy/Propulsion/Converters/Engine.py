...
# RCAIDE/Energy/Propulsion/Converters/Engine.py
# 
# 
...
class Engine(Energy_Component):
    ...
    def calculate_power_out_from_throttle(self,conditions,throttle):
    ...
    def calculate_fuel_flow_rate_from_torque(self,conditions):
        """ The internal combustion engine output power and specific power consumption
    ...
    def calculate_throttle_out_from_power(self,conditions):
        """ The internal combustion engine output power and specific power consumption
