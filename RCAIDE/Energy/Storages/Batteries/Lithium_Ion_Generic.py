...
class Lithium_Ion_Generic(Battery):
    ...
    def assign_battery_unknowns(self,segment,b_i): 
        ...
        battery_conditions                          = segment.state.conditions.energy['battery_' + str(b_i)]         
        battery_conditions.pack.voltage_under_load  = segment.state.unknowns['battery_voltage_under_load_' + str(b_i)] 
    ...
    def assign_battery_residuals(self,segment,b_i,network): 
        ...
        v_predict          = segment.state.unknowns['battery_voltage_under_load_' + str(b_i)]  
        v_max              = network.voltage
        
        # Return the residuals
        segment.state.residuals.battery['voltage_' + str(b_i)]  = (v_predict - v_actual)/v_max
    ...
    def append_battery_unknowns_and_residuals_to_segment(self,
                                                         ...
                                                         bus_tag,
                                                         estimated_voltage, 
                                                         estimated_battery_cell_temperature , 
                                                         estimated_battery_state_of_charges,
                                                         estimated_battery_cell_currents): 
        ...
        if estimated_voltage==None:
            estimated_voltage = self.pack.maximum_voltage
        segment.state.unknowns[bus_tag + 'battery_voltage_under_load']  = estimated_voltage * ones_row(1)     
