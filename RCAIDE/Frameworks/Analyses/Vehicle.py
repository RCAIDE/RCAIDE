...
class Vehicle(Analysis.Container):
    """ RCAIDE.Frameworks.Analyses.Vehicle()
    ...
    def __init__(self,*args,**kwarg):
        ...
        self._analyses_map = { 
            RCAIDE.Frameworks.Analyses.Weights.Weights           : 'weights'      ,
            RCAIDE.Frameworks.Analyses.Aerodynamics.Aerodynamics : 'aerodynamics' ,
            RCAIDE.Frameworks.Analyses.Stability.Stability       : 'stability'    ,
            RCAIDE.Frameworks.Analyses.Energy.Energy             : 'energy'       ,
            RCAIDE.Frameworks.Analyses.Atmospheric.Atmospheric   : 'atmosphere'   ,
            RCAIDE.Frameworks.Analyses.Planets.Planet            : 'planet'       ,
            RCAIDE.Frameworks.Analyses.Noise.Noise               : 'noise'        ,
            RCAIDE.Frameworks.Analyses.Costs.Costs               : 'costs'        ,
        }
