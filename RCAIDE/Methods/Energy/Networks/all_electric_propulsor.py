    ...
    for i in range(len(assigned_propulsors)):
        ...
        if propulsor.active == True:  
            if bus.identical_propulsors == False:
                # run analysis  
                total_thrust , total_power ,  total_current ,stored_results,stored_propulsor_tag = compute_performance(conditions,voltage,bus,propulsor,total_thrust,total_power,total_current)
            else:             
...
def compute_performance(conditions,voltage,bus,propulsor,total_thrust,total_power,total_current): 
    ...
    return total_thrust , total_power ,  total_current ,stored_results,stored_propulsor_tag
