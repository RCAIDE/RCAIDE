...
def size_conjugate_cooling(Q_gen, battery, heat_gen, m_coolant_lower_bound=0.01, Res_lower_bound = 0.0, m_coolant_upper_bound=10.0, Res_upper_bound = 5): 
    ...
    sol = minimize(objective, m_coolant=0.5, args=(heat_gen) , method='SLSQP', bounds=bnds, tol=1e-6, constraints=hard_cons) 
    
    return sol.x   


# objective function
def objective( Q_gen,battery,heat_gen ) : 
