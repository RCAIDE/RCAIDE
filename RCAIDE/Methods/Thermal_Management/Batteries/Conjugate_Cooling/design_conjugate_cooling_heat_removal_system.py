...
def size_conjugate_cooling(Q_gen, battery, kv_lower_bound =  0.01, Res_lower_bound = 0.001, kv_upper_bound = 100, Res_upper_bound = 10 ): 
    ...
    sol = minimize(objective, 1.0 , args=( ) , method='SLSQP', bounds=bnds, tol=1e-6, constraints=hard_cons) 
