...
def modify_channel_cooling_hex(nexus): 
    ...
    PI_h_guess                     = hex_opt.air_pressure_ratio  
    d_H_c                    = hex_opt.air_hydraulic_diameter
    gamma_chan_c             = hex_opt.aspect_ratio_of_cold_fluid_channel  
    ...
    fan_efficiency           = hex_opt.fab_efficiency    
    ...
    A_f_div_A_h   = gamma_chan_h/(1+gamma_chan_h) # eqn 21 
    A_f_div_A_c   = gamma_chan_c/(1+gamma_chan_c)
    ...
    delta_p_h_true    = 2*f_h*(rho_h*(u_h**2))*(L_chan/d_H_h)
    rho_c_m           = 2/(1/rho_c_1 + 1/rho_c_2)
    delta_p_c_true    = (G_h**2 / (2 * rho_c_1)) * ((1 - sigma_c**2 + Kc_c)  + 2 * (rho_c_1 / rho_c_2 - 1) + f_c * 4 * L_c / d_H_c * rho_c_1 / rho_c_m  - (1 - sigma_c**2 - Ke_c) * rho_c_1 / rho_c_2)  #eqn 43 
    ...
    j_div_f_c_residual = j_div_f_c_guess-j_div_f_c_true 
    j_div_f_h_residual = j_div_f_h_guess-j_div_f_h_true 

    eta_0_c_residual   = eta_0_c_guess - eta_0_c
    eta_0_h_residual   = eta_0_h_guess - eta_0_h
    
    PI_c_true          = 1-delta_p_c_true/p_c_1
    PI_h_true          = 1-delta_p_h_true/p_h_1
    
    PI_c_residual      = PI_c_guess - PI_c_true
    PI_h_residual      = PI_h_guess - PI_h_true
