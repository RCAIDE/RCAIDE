...
def SAE_turbofan_engine_noise_model(turbofan,segment,analyses,config,settings,ioprint = 0, filename = 0):  
    ...
    Inputs:
        ...
        airport   - RCAIDE type airport data, with followig fields:
            atmosphere                  - Airport atmosphere (RCAIDE type)
