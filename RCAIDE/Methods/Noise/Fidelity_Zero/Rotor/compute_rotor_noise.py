# RCAIDE/Methods/Noise/Fidelity_Zero/Rotor/compute_rotor_noise.py
...
from RCAIDE.Methods.Noise.Fidelity_Zero.Rotor.compute_harmonic_noise    import compute_harmonic_noise
from RCAIDE.Methods.Noise.Fidelity_Zero.Rotor.compute_broadband_noise   import compute_broadband_noise
from RCAIDE.Methods.Noise.Common                                        import atmospheric_attenuation
from RCAIDE.Methods.Noise.Metrics.A_weighting_metric                    import A_weighting_metric  
...
def compute_rotor_noise(rotors,aeroacoustic_data,segment,settings):
