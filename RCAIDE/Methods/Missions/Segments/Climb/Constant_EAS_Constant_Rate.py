...
# RCAIDE/Methods/Missions/Segments/Climb/Constant_EAS_Constant_Rate.py
...
def initialize_conditions(segment):
    ...
    if eas is None:
        ...
        RCAIDE.Methods.Missions.Segments.Common.Aerodynamics.update_atmosphere(segment) # get density for airspeed
