...
# RCAIDE/Methods/Missions/Segments/Cruise/Constant_Dynamic_Pressure_Constant_Altitude_Loiter.py
...
def initialize_conditions(segment):
    ...
    RCAIDE.Methods.Missions.Segments.Common.Aerodynamics.update_atmosphere(segment)
