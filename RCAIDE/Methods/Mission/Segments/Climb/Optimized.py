...
# RCAIDE/Methods/Missions/Segments/Climb/Optimized.py
# 
# 
...
# ----------------------------------------------------------------------------------------------------------------------  
#  Solve Linear Speed Constant Rate
# ----------------------------------------------------------------------------------------------------------------------      
## @ingroup Methods-Missions-Segments-Climb
def solve_linear_speed_constant_rate(segment):
    ...
    mini_mission = RCAIDE.Analyses.Mission.Sequential_Segments()
    
    LSCR = RCAIDE.Analyses.Mission.Segments.Climb.Linear_Speed_Constant_Rate()
    ...
    segment.state.unknowns.flight_path_angle = LSCR_res.state.unknowns.body_angle - LSCR_res.conditions.aerodynamics.angles.alpha
