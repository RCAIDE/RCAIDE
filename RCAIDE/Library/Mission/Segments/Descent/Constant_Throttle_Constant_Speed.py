# RCAIDE/Library/Missions/Segments/Descent/Constant_Throttle_Constant_Speed.py
# 
# 
...
def unpack_body_angle(segment):
    ...
    Notes
    -----
    This function handles the initialization of the body angle for a descent segment
