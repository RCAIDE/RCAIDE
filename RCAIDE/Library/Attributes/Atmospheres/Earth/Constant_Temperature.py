...
class Constant_Temperature(Atmosphere):
    ...
    def __defaults__(self):
        ...
        self.planet = Earth()
        self.breaks = Data()
        self.breaks.altitude    = rp.array( [-2.00    , 0.00,     11.00,      20.00,      32.00,      47.00,      51.00,      71.00,      84.852]) * Units.km     # m, geopotential altitude
        ...
        self.breaks.density     = rp.array( [1.545586 , 1.2256523,.273764,	 .0662256,	0.0105000 ,	1.3415E-03,	8.0971E-04,	4.78579E-05, 4.51674E-06]) #kg/m^3 
