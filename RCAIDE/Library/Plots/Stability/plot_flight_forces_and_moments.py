## @ingroup Visualization-Stability
# RCAIDE/Visualization/Stability/plot_stability_forces_and_moments.py
# 
# 
...
def plot_flight_forces_and_moments(results,
    ...
    for i in range(len(results.segments)): 
        ...
        axis_2.plot(time,L, color = line_colors[i], marker = ps.markers[0], linewidth = ps.line_width, label = segment_name) 
        set_axes(axis_2)     
