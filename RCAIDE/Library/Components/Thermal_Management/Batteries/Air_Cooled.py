...
class Air_Cooled(Component):
    ...
    def unpack_propulsor_unknowns(self,segment,coolant_line,add_additional_network_equation = False):   
        return
    ...
    def compute_thermal_performance(self,battery,Q_heat_gen,T_cell,state,dt,i): 
        ...
        T_current = air_cooling_performance(self, battery, Q_heat_gen, T_cell, state, dt, i)
