...
def _broadband_noise(State, Settings, System):
	'''
	Framework version of broadband_noise.
	Wraps broadband_noise with State, Settings, System pack/unpack.
	Please see broadband_noise documentation for more details.
	'''
	...
	results = broadband_noise('freestream', 'angle_of_attack', 'coordinates', 'velocity_vector', 'rotor', 'aeroacoustic_data', 'settings', 'res')
...
def _flatten_matrix(State, Settings, System):
	'''
	Framework version of flatten_matrix.
	Wraps flatten_matrix with State, Settings, System pack/unpack.
	Please see flatten_matrix documentation for more details.
	'''

	#TODO: x          = [Replace With State, Settings, or System Attribute]
	#TODO: num_mic    = [Replace With State, Settings, or System Attribute]
	#TODO: num_rot    = [Replace With State, Settings, or System Attribute]
	#TODO: num_blades = [Replace With State, Settings, or System Attribute]
	#TODO: num_sec    = [Replace With State, Settings, or System Attribute]
	#TODO: num_cf     = [Replace With State, Settings, or System Attribute]

	results = flatten_matrix('x', 'num_mic', 'num_rot', 'num_blades', 'num_sec', 'num_cf')
	#TODO: [Replace results with the output of the original function]
...
def _unflatten_matrix(State, Settings, System):
	'''
	Framework version of unflatten_matrix.
	Wraps unflatten_matrix with State, Settings, System pack/unpack.
	Please see unflatten_matrix documentation for more details.
	'''
	...
	results = unflatten_matrix('x', 'num_mic', 'num_rot', 'num_blades', 'num_sec', 'num_cf')
	#TODO: [Replace results with the output of the original function]
