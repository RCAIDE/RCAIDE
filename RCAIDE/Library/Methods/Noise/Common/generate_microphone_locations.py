...
def _generate_zero_elevation_microphone_locations(State, Settings, System):
	'''
	Framework version of generate_zero_elevation_microphone_locations.
	Wraps generate_zero_elevation_microphone_locations with State, Settings, System pack/unpack.
	Please see generate_zero_elevation_microphone_locations documentation for more details.
	'''

	#TODO: settings = [Replace With State, Settings, or System Attribute]

	results = generate_zero_elevation_microphone_locations('settings',)
...
def _generate_terrain_elevated_microphone_locations(State, Settings, System):
	'''
	Framework version of generate_terrain_elevated_microphone_locations.
	Wraps generate_terrain_elevated_microphone_locations with State, Settings, System pack/unpack.
	Please see generate_terrain_elevated_microphone_locations documentation for more details.
	'''
	...
	#TODO: ground_microphone_x_resolution = [Replace With State, Settings, or System Attribute]
	#TODO: ground_microphone_y_resolution = [Replace With State, Settings, or System Attribute]
	#TODO: ground_microphone_x_stencil    = [Replace With State, Settings, or System Attribute]
	#TODO: ground_microphone_y_stencil    = [Replace With State, Settings, or System Attribute]
	#TODO: adjusted_cruise_distance       = [Replace With State, Settings, or System Attribute]

	results = generate_terrain_elevated_microphone_locations('topography_file', 'departure_coordinates', 'destination_coordinates', 'ground_microphone_x_resolution', 'ground_microphone_y_resolution', 'ground_microphone_x_stencil', 'ground_microphone_y_stencil', 'adjusted_cruise_distance')
	#TODO: [Replace results with the output of the original function]
...
def _generate_noise_hemisphere_microphone_locations(State, Settings, System):
	'''
	Framework version of generate_noise_hemisphere_microphone_locations.
	Wraps generate_noise_hemisphere_microphone_locations with State, Settings, System pack/unpack.
	Please see generate_noise_hemisphere_microphone_locations documentation for more details.
	'''

	#TODO: settings = [Replace With State, Settings, or System Attribute]

	results = generate_noise_hemisphere_microphone_locations('settings',)
	#TODO: [Replace results with the output of the original function]
