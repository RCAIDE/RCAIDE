...
## @ingroup Methods-Noise-Fidelity_One-Noise_Tools
def func_senel_noise(SPLt_dBA_max):
...
def senel_noise(State, Settings, System):
	#TODO: SPLt_dBA_max = [Replace With State, Settings, or System Attribute]

	results = func_senel_noise('SPLt_dBA_max',)
