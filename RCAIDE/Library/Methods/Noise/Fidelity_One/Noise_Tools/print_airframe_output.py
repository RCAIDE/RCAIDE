...
## @ingroup Methods-Noise-Fidelity_One-Noise_Tools
def func_print_airframe_output(SAE_Airframe_Noise_Outputs): 
...
def print_airframe_output(State, Settings, System):
	#TODO: SAE_Airframe_Noise_Outputs = [Replace With State, Settings, or System Attribute]

	results = func_print_airframe_output('SAE_Airframe_Noise_Outputs',)
