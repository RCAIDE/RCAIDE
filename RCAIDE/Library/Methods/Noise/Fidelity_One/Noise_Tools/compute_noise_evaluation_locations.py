...
# ---------------------------------------------------------------------
## @ingroup Methods-Noise-Fidelity_One-Noise_Tools 
def func_compute_ground_noise_evaluation_locations(settings,segment):
...
## @ingroup Methods-Noise-Fidelity_One-Noise_Tools 
def func_compute_building_noise_evaluation_locations(settings,segment):
    """This computes the relative locations on the surface in the computational domain where the 
...
def compute_ground_noise_evaluation_locations(State, Settings, System):
	#TODO: settings = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = func_compute_ground_noise_evaluation_locations('settings', 'segment')
...
def compute_building_noise_evaluation_locations(State, Settings, System):
	#TODO: settings = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = func_compute_building_noise_evaluation_locations('settings', 'segment')
	#TODO: [Replace results with the output of the original function]
