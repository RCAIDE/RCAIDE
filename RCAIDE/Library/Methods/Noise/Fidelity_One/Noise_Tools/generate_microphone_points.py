...
# ---------------------------------------------------------------------
## @ingroup Methods-Noise-Fidelity_One-Noise_Tools 
def func_generate_ground_microphone_points(min_x,max_x,min_y,max_y,N_x,N_y):
...
## @ingroup Methods-Noise-Fidelity_One-Noise_Tools 
def func_generate_building_microphone_points(building_locations,building_dimensions,N_x,N_y,N_z):
...
def generate_ground_microphone_points(State, Settings, System):
	#TODO: min_x = [Replace With State, Settings, or System Attribute]
	#TODO: max_x = [Replace With State, Settings, or System Attribute]
	#TODO: min_y = [Replace With State, Settings, or System Attribute]
	#TODO: max_y = [Replace With State, Settings, or System Attribute]
	#TODO: N_x   = [Replace With State, Settings, or System Attribute]
	#TODO: N_y   = [Replace With State, Settings, or System Attribute]

	results = func_generate_ground_microphone_points('min_x', 'max_x', 'min_y', 'max_y', 'N_x', 'N_y')
...
def generate_building_microphone_points(State, Settings, System):
	#TODO: building_locations  = [Replace With State, Settings, or System Attribute]
	#TODO: building_dimensions = [Replace With State, Settings, or System Attribute]
	#TODO: N_x                 = [Replace With State, Settings, or System Attribute]
	#TODO: N_y                 = [Replace With State, Settings, or System Attribute]
	#TODO: N_z                 = [Replace With State, Settings, or System Attribute]

	results = func_generate_building_microphone_points('building_locations', 'building_dimensions', 'N_x', 'N_y', 'N_z')
	#TODO: [Replace results with the output of the original function]
