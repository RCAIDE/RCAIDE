...
## @ingroup Methods-Noise-Fidelity_One-Engine
def func_external_plug_effect(Velocity_primary,Velocity_secondary, Velocity_mixed, Diameter_primary,
...
def external_plug_effect(State, Settings, System):
	...
	results = func_external_plug_effect('Velocity_primary', 'Velocity_secondary', 'Velocity_mixed', 'Diameter_primary', 'Diameter_secondary', 'Diameter_mixed', 'Plug_diameter', 'sound_ambient', 'theta_p', 'theta_s', 'theta_m')
