...
## @ingroup Methods-Noise-Fidelity_One-Engine
def func_noise_source_location(B,Xo,zk,Diameter_primary,theta_p,Area_primary,Area_secondary,distance_microphone,
...
def noise_source_location(State, Settings, System):
	...
	results = func_noise_source_location('B', 'Xo', 'zk', 'Diameter_primary', 'theta_p', 'Area_primary', 'Area_secondary', 'distance_microphone', 'Diameter_secondary', 'theta', 'theta_s', 'theta_m', 'Diameter_mixed', 'Velocity_primary', 'Velocity_secondary', 'Velocity_mixed', 'Velocity_aircraft', 'sound_ambient', 'Str_m', 'Str_s')
