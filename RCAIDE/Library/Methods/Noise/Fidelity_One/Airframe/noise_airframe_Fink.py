...
## @ingroup Methods-Noise-Fidelity_One-Airframe
def func_noise_airframe_Fink(segment,analyses,config,settings,ioprint = 0, filename=0):  
...
def noise_airframe_Fink(State, Settings, System):
	...
	#TODO: ioprint  = [Replace With State, Settings, or System Attribute]
	#TODO: filename = [Replace With State, Settings, or System Attribute]

	results = func_noise_airframe_Fink('segment', 'analyses', 'config', 'settings', 'ioprint', 'filename')
