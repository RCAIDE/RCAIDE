...
## @ingroup Methods-Noise-Fidelity_One-Airframe
def func_noise_landing_gear(D,H,wheels,M,velocity,phi,theta,distance,frequency):
...
def noise_landing_gear(State, Settings, System):
	...
	results = func_noise_landing_gear('D', 'H', 'wheels', 'M', 'velocity', 'phi', 'theta', 'distance', 'frequency')
