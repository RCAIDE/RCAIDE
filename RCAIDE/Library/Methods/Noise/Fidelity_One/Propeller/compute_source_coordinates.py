...
def func_compute_point_source_coordinates(conditions,rotors,mls,settings):  
...
def func_compute_blade_section_source_coordinates(AoA,acoustic_outputs,rotors,mls,settings):  
    """This calculated the position vector from a point source to the observer 
...
def compute_point_source_coordinates(State, Settings, System):
	#TODO: conditions = [Replace With State, Settings, or System Attribute]
	#TODO: rotors     = [Replace With State, Settings, or System Attribute]
	#TODO: mls        = [Replace With State, Settings, or System Attribute]
	#TODO: settings   = [Replace With State, Settings, or System Attribute]

	results = func_compute_point_source_coordinates('conditions', 'rotors', 'mls', 'settings')
...
def compute_blade_section_source_coordinates(State, Settings, System):
	#TODO: AoA              = [Replace With State, Settings, or System Attribute]
	#TODO: acoustic_outputs = [Replace With State, Settings, or System Attribute]
	#TODO: rotors           = [Replace With State, Settings, or System Attribute]
	#TODO: mls              = [Replace With State, Settings, or System Attribute]
	#TODO: settings         = [Replace With State, Settings, or System Attribute]

	results = func_compute_blade_section_source_coordinates('AoA', 'acoustic_outputs', 'rotors', 'mls', 'settings')
	#TODO: [Replace results with the output of the original function]
