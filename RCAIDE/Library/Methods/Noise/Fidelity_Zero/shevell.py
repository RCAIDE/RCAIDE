...
## @ingroup Methods-Noise-Fidelity_Zero
def func_shevell(weight_landing, number_of_engines, thrust_sea_level, thrust_landing):
...
def shevell(State, Settings, System):
	#TODO: weight_landing    = [Replace With State, Settings, or System Attribute]
	#TODO: number_of_engines = [Replace With State, Settings, or System Attribute]
	#TODO: thrust_sea_level  = [Replace With State, Settings, or System Attribute]
	#TODO: thrust_landing    = [Replace With State, Settings, or System Attribute]

	results = func_shevell('weight_landing', 'number_of_engines', 'thrust_sea_level', 'thrust_landing')
