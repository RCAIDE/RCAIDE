...
def _noise_source_location(State, Settings, System):
	'''
	Framework version of noise_source_location.
	Wraps noise_source_location with State, Settings, System pack/unpack.
	Please see noise_source_location documentation for more details.
	'''

	#TODO: B                   = [Replace With State, Settings, or System Attribute]
	#TODO: Xo                  = [Replace With State, Settings, or System Attribute]
	#TODO: zk                  = [Replace With State, Settings, or System Attribute]
	...
	#TODO: distance_microphone = [Replace With State, Settings, or System Attribute]
	...
	results = noise_source_location('B', 'Xo', 'zk', 'Diameter_primary', 'theta_p', 'Area_primary', 'Area_secondary', 'distance_microphone', 'Diameter_secondary', 'theta', 'theta_s', 'theta_m', 'Diameter_mixed', 'Velocity_primary', 'Velocity_secondary', 'Velocity_mixed', 'Velocity_aircraft', 'sound_ambient', 'Str_m', 'Str_s')
