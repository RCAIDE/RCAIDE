...
## @ingroup Methods-Flight_Dynamics-Static_Stability-Approximations-Tube_wing
def func_taw_cmalpha(geometry,mach,conditions,configuration):
...
def taw_cmalpha(State, Settings, System):
	...
	results = func_taw_cmalpha('geometry', 'mach', 'conditions', 'configuration')
