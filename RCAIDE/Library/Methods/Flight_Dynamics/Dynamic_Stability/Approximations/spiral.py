...
## @ingroup Methods-Flight_Dynamics-Dynamic_Stability-Approximations
def func_spiral(mass, velocity, density, S_gross_w, Cl_p, Cn_Beta, Cy_phi, Cl_Beta, Cn_r, Cl_r):
...
def spiral(State, Settings, System):
	...
	results = func_spiral('mass', 'velocity', 'density', 'S_gross_w', 'Cl_p', 'Cn_Beta', 'Cy_phi', 'Cl_Beta', 'Cn_r', 'Cl_r')
