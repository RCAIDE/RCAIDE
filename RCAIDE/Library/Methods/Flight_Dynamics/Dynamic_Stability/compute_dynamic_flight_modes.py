...
## @ingroup Analyses-AVL
def func_compute_dynamic_flight_modes(results,aircraft,flight_conditions,cases): 
...
def compute_dynamic_flight_modes(State, Settings, System):
	...
	#TODO: flight_conditions = [Replace With State, Settings, or System Attribute]
	#TODO: cases             = [Replace With State, Settings, or System Attribute]

	results = func_compute_dynamic_flight_modes('results', 'aircraft', 'flight_conditions', 'cases')
