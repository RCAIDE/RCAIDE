...
## @ingroup Methods-Missions-Segments-Common
def func_initialize_weights(segment):
...
## @ingroup Methods-Missions-Segments-Common
def func_update_gravity(segment):
...
def initialize_weights(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_initialize_weights('segment',)
...
def update_gravity(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_update_gravity('segment',)
	#TODO: [Replace results with the output of the original function]
