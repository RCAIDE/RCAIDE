...
## @ingroup Methods-Missions-Segments-Common   
def func_expand_sub_segments(segment):
...
## @ingroup Methods-Missions-Segments-Common
def func_update_sub_segments(segment):
...
## @ingroup Methods-Missions-Segments-Common
def func_finalize_sub_segments(segment):
...
## @ingroup Methods-Missions-Segments-Common
def func_sequential_sub_segments(segment):
...
## @ingroup Methods-Missions-Segments-Common
def func_merge_sub_segment_states(segment):
...
## @ingroup Methods-Missions-Segments-Common
def func_unpack_subsegments(segment):
...
def expand_sub_segments(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_expand_sub_segments('segment',)
...
def update_sub_segments(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_update_sub_segments('segment',)
	#TODO: [Replace results with the output of the original function]
...
def finalize_sub_segments(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_finalize_sub_segments('segment',)
	#TODO: [Replace results with the output of the original function]
...
def sequential_sub_segments(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_sequential_sub_segments('segment',)
	#TODO: [Replace results with the output of the original function]
...
def merge_sub_segment_states(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_merge_sub_segment_states('segment',)
	#TODO: [Replace results with the output of the original function]
...
def unpack_subsegments(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = func_unpack_subsegments('segment',)
	#TODO: [Replace results with the output of the original function]
