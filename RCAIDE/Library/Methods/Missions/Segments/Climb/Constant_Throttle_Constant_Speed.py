...
unpack_body_angle(State, Settings, System):
...
update_differentials_altitude(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]
...
update_velocity_vector_from_wind_angle(State, Settings, System):
	#TODO: segment = [Replace With State, Settings, or System Attribute]
