...
# ----------------------------------------------------------------------
## @ingroup Methods-Weights-Correlations-General_Aviation
def func_wing_main(S_wing, m_fuel, AR_w, sweep_w, q_c, taper_w, t_c_w,Nult,TOW):      
    """ 
...
def wing_main(State, Settings, System):
	#TODO: S_wing  = [Replace With State, Settings, or System Attribute]
	#TODO: m_fuel  = [Replace With State, Settings, or System Attribute]
	#TODO: AR_w    = [Replace With State, Settings, or System Attribute]
	#TODO: sweep_w = [Replace With State, Settings, or System Attribute]
	#TODO: q_c     = [Replace With State, Settings, or System Attribute]
	#TODO: taper_w = [Replace With State, Settings, or System Attribute]
	...
	results = func_wing_main('S_wing', 'm_fuel', 'AR_w', 'sweep_w', 'q_c', 'taper_w', 't_c_w', 'Nult', 'TOW')
