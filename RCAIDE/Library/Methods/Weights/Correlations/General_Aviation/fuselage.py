...
# ----------------------------------------------------------------------
## @ingroup Methods-Weights-Correlations-General_Aviation
def func_fuselage(S_fus, Nult, TOW, w_fus, h_fus, l_fus, l_ht, q_c, V_fuse, diff_p_fus):
    """ 
...
fuselage(State, Settings, System):
	#TODO: S_fus      = [Replace With State, Settings, or System Attribute]
	#TODO: Nult       = [Replace With State, Settings, or System Attribute]
	#TODO: TOW        = [Replace With State, Settings, or System Attribute]
	#TODO: w_fus      = [Replace With State, Settings, or System Attribute]
	#TODO: h_fus      = [Replace With State, Settings, or System Attribute]
	#TODO: l_fus      = [Replace With State, Settings, or System Attribute]
	#TODO: l_ht       = [Replace With State, Settings, or System Attribute]
	#TODO: q_c        = [Replace With State, Settings, or System Attribute]
	#TODO: V_fuse     = [Replace With State, Settings, or System Attribute]
	#TODO: diff_p_fus = [Replace With State, Settings, or System Attribute]

	results = func_fuselage('S_fus', 'Nult', 'TOW', 'w_fus', 'h_fus', 'l_fus', 'l_ht', 'q_c', 'V_fuse', 'diff_p_fus')
