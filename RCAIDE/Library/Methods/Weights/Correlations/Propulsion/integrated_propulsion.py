...
## @ingroup Methods-Weights-Correlations-Propulsion
def func_integrated_propulsion(engine_jet,num_eng, engine_wt_factor = 1.6):
...
def integrated_propulsion(State, Settings, System):
	#TODO: engine_jet       = [Replace With State, Settings, or System Attribute]
	...
	results = func_integrated_propulsion('engine_jet', 'num_eng', 'engine_wt_factor')
