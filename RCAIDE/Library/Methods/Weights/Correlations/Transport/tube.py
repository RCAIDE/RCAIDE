...
## @ingroup Methods-Weights-Correlations-Tube_Wing
def func_tube(vehicle, fuse, wt_wing, wt_propulsion):
...
def tube(State, Settings, System):
	#TODO: vehicle       = [Replace With State, Settings, or System Attribute]
	#TODO: fuse          = [Replace With State, Settings, or System Attribute]
	#TODO: wt_wing       = [Replace With State, Settings, or System Attribute]
	#TODO: wt_propulsion = [Replace With State, Settings, or System Attribute]

	results = func_tube('vehicle', 'fuse', 'wt_wing', 'wt_propulsion')
