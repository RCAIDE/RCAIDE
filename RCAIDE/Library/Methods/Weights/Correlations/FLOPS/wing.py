...
wing_weight_FLOPS(State, Settings, System):
...
generate_wing_stations(State, Settings, System):
...
generate_int_stations(State, Settings, System):
...
calculate_load(State, Settings, System):
	#TODO: ETA = [Replace With State, Settings, or System Attribute]
...
find_sweep(State, Settings, System):
...
get_spanwise_engine(State, Settings, System):
...
wing_weight_constants_FLOPS(State, Settings, System):
...
determine_fuselage_chord(State, Settings, System):
	#TODO: fuselage_width = [Replace With State, Settings, or System Attribute]
	#TODO: wing           = [Replace With State, Settings, or System Attribute]
