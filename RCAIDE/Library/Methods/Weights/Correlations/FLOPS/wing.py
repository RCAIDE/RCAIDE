...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_wing_weight_FLOPS(vehicle, wing, WPOD, complexity, settings, num_main_wings):
...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_generate_wing_stations(fuselage_width, wing):
...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_generate_int_stations(NSD, ETA):
...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_find_sweep(y, lst_y, swp):
...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_get_spanwise_engine(networks, SEMISPAN):
...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_wing_weight_constants_FLOPS(ac_type):
...
## @ingroup Methods-Weights-Correlations-FLOPS
def func_determine_fuselage_chord(fuselage_width, wing):
...
def wing_weight_FLOPS(State, Settings, System):
	#TODO: vehicle        = [Replace With State, Settings, or System Attribute]
	#TODO: wing           = [Replace With State, Settings, or System Attribute]
	#TODO: WPOD           = [Replace With State, Settings, or System Attribute]
	#TODO: complexity     = [Replace With State, Settings, or System Attribute]
	#TODO: settings       = [Replace With State, Settings, or System Attribute]
	#TODO: num_main_wings = [Replace With State, Settings, or System Attribute]

	results = func_wing_weight_FLOPS('vehicle', 'wing', 'WPOD', 'complexity', 'settings', 'num_main_wings')
...
def generate_wing_stations(State, Settings, System):
	#TODO: fuselage_width = [Replace With State, Settings, or System Attribute]
	#TODO: wing           = [Replace With State, Settings, or System Attribute]

	results = func_generate_wing_stations('fuselage_width', 'wing')
	#TODO: [Replace results with the output of the original function]
...
def generate_int_stations(State, Settings, System):
	#TODO: NSD = [Replace With State, Settings, or System Attribute]
	#TODO: ETA = [Replace With State, Settings, or System Attribute]

	results = func_generate_int_stations('NSD', 'ETA')
	#TODO: [Replace results with the output of the original function]
...
def calculate_load(State, Settings, System):
	#TODO: ETA = [Replace With State, Settings, or System Attribute]

	results = func_calculate_load('ETA',)
	#TODO: [Replace results with the output of the original function]
...
def find_sweep(State, Settings, System):
	#TODO: y     = [Replace With State, Settings, or System Attribute]
	#TODO: lst_y = [Replace With State, Settings, or System Attribute]
	#TODO: swp   = [Replace With State, Settings, or System Attribute]

	results = func_find_sweep('y', 'lst_y', 'swp')
	#TODO: [Replace results with the output of the original function]
...
def get_spanwise_engine(State, Settings, System):
	#TODO: networks = [Replace With State, Settings, or System Attribute]
	#TODO: SEMISPAN = [Replace With State, Settings, or System Attribute]

	results = func_get_spanwise_engine('networks', 'SEMISPAN')
	#TODO: [Replace results with the output of the original function]
...
def wing_weight_constants_FLOPS(State, Settings, System):
	#TODO: ac_type = [Replace With State, Settings, or System Attribute]

	results = func_wing_weight_constants_FLOPS('ac_type',)
	#TODO: [Replace results with the output of the original function]
...
def determine_fuselage_chord(State, Settings, System):
	#TODO: fuselage_width = [Replace With State, Settings, or System Attribute]
	#TODO: wing           = [Replace With State, Settings, or System Attribute]

	results = func_determine_fuselage_chord('fuselage_width', 'wing')
	#TODO: [Replace results with the output of the original function]
