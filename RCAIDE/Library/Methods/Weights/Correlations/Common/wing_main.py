...
## @ingroup Methods-Weights-Correlations-Common
def func_wing_main(vehicle, wing, rho, sigma, computation_type = 'segmented'):
...
def wing_main(State, Settings, System):
	...
	#TODO: rho              = [Replace With State, Settings, or System Attribute]
	#TODO: sigma            = [Replace With State, Settings, or System Attribute]
	#TODO: computation_type = [Replace With State, Settings, or System Attribute]

	results = func_wing_main('vehicle', 'wing', 'rho', 'sigma', 'computation_type')
...
def big_integral(State, Settings, System):
	...
	results = func_big_integral('x', 'A', 'B', 'C')
	#TODO: [Replace results with the output of the original function]
