...
## @ingroup Methods-Weights-Correlations-Common
def func_landing_gear(vehicle, landing_gear_wt_factor=0.04):
...
def landing_gear(State, Settings, System):
	...
	#TODO: landing_gear_wt_factor = [Replace With State, Settings, or System Attribute]

	results = func_landing_gear('vehicle', 'landing_gear_wt_factor')
