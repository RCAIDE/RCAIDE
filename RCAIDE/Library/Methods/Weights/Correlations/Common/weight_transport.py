...
def func_empty_weight(vehicle, settings=None, method_type='New SUAVE'):
...
def empty_weight(State, Settings, System):
	...
	#TODO: method_type = [Replace With State, Settings, or System Attribute]

	results = func_empty_weight('vehicle', 'settings', 'method_type')
