...
## @ingroup Methods-Weights-Correlations-Raymer
def func_tail_vertical_Raymer(vehicle, wing):
...
## @ingroup Methods-Weights-Correlations-Raymer
def func_tail_horizontal_Raymer(vehicle, wing, elevator_fraction=0.4):
...
def tail_horizontal_Raymer(State, Settings, System):
	#TODO: vehicle           = [Replace With State, Settings, or System Attribute]
	#TODO: wing              = [Replace With State, Settings, or System Attribute]
	#TODO: elevator_fraction = [Replace With State, Settings, or System Attribute]

	results = func_tail_horizontal_Raymer('vehicle', 'wing', 'elevator_fraction')
	#TODO: [Replace results with the output of the original function]
