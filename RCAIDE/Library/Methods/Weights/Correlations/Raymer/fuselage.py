...
## @ingroup Methods-Weights-Correlations-Raymer
def func_fuselage_weight_Raymer(vehicle, fuse, settings):
...
def fuselage_weight_Raymer(State, Settings, System):
	...
	results = func_fuselage_weight_Raymer('vehicle', 'fuse', 'settings')
