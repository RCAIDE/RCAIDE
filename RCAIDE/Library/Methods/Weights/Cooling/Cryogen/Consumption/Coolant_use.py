...
## @ingroup Methods-Cooling-cryogen-Consumption
def func_Coolant_use(cryogen,cryogen_temp,equipment_temp,cooling_required,pressure):
...
def Coolant_use(State, Settings, System):
	...
	results = func_Coolant_use('cryogen', 'cryogen_temp', 'equipment_temp', 'cooling_required', 'pressure')
