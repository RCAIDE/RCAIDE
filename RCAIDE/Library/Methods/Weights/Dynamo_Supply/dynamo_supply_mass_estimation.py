...
def func_dynamo_supply_mass_estimation(HTS_Dynamo_Supply):
...
def dynamo_supply_mass_estimation(State, Settings, System):
	#TODO: HTS_Dynamo_Supply = [Replace With State, Settings, or System Attribute]

	results = func_dynamo_supply_mass_estimation('HTS_Dynamo_Supply',)
