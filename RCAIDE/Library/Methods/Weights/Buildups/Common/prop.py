...
def prop(State, Settings, System):
	...
	results = func_prop('prop', 'maximum_lifting_thrust', 'chord_to_radius_ratio', 'thickness_to_chord', 'root_to_radius_ratio', 'moment_to_lift_ratio', 'spanwise_analysis_points', 'safety_factor', 'margin_factor', 'forward_web_locations', 'shear_center', 'speed_of_sound', 'tip_max_mach_number')
