...
def pack_battery_conditions(battery_conditions,battery): 
    ...
    battery_power_draw = battery_conditions.pack.power_draw    
        
    battery_conditions.pack.current                         = battery_conditions.pack.current
    ...
    battery_conditions.cell.power                           = battery_conditions.pack.power/n_series
