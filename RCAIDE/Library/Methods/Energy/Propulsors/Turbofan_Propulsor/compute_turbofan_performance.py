...
def _compute_turbofan_performance(State, Settings, System):
	'''
	Framework version of compute_turbofan_performance.
	Wraps compute_turbofan_performance with State, Settings, System pack/unpack.
	Please see compute_turbofan_performance documentation for more details.
	'''

	#TODO: fuel_line = [Replace With State, Settings, or System Attribute]
	#TODO: state     = [Replace With State, Settings, or System Attribute]

	results = compute_turbofan_performance('fuel_line', 'state')
...
def _compute_performance(State, Settings, System):
	'''
	Framework version of compute_performance.
	Wraps compute_performance with State, Settings, System pack/unpack.
	Please see compute_performance documentation for more details.
	'''
	...
	#TODO: total_thrust = [Replace With State, Settings, or System Attribute]
	#TODO: total_power  = [Replace With State, Settings, or System Attribute]

	results = compute_performance('conditions', 'fuel_line', 'turbofan', 'total_thrust', 'total_power')
	#TODO: [Replace results with the output of the original function]
...
def _reuse_stored_data(State, Settings, System):
	'''
	Framework version of reuse_stored_data.
	Wraps reuse_stored_data with State, Settings, System pack/unpack.
	Please see reuse_stored_data documentation for more details.
	'''

	#TODO: conditions           = [Replace With State, Settings, or System Attribute]
	#TODO: fuel_line            = [Replace With State, Settings, or System Attribute]
	#TODO: turbofan             = [Replace With State, Settings, or System Attribute]
	#TODO: stored_propulsor_tag = [Replace With State, Settings, or System Attribute]
	#TODO: total_thrust         = [Replace With State, Settings, or System Attribute]
	#TODO: total_power          = [Replace With State, Settings, or System Attribute]

	results = reuse_stored_data('conditions', 'fuel_line', 'turbofan', 'stored_propulsor_tag', 'total_thrust', 'total_power')
	#TODO: [Replace results with the output of the original function]
