...
# ---------------------------------------------------------------------------------------------------------------------- 
## @ingroup Energy-Propulsion-Converters 
def spin_rotor(rotor,conditions):
    ...
    sweep    = rotor.sweep_distribution     # quarter chord distance from quarter chord of root airfoil
    ...
    pitch_c               = rotor.inputs.pitch_command
    ...
    body2thrust     = rotor.vehicle_to_velocity_frame_rotation()
    ...
    # Store data
    rotor.azimuthal_distribution                   = psi
