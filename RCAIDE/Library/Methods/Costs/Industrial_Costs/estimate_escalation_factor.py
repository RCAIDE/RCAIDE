...
## @ingroup Methods-Costs-Industrial_Costs
def func_estimate_escalation_factor(reference_year):
...
def estimate_escalation_factor(State, Settings, System):
	#TODO: reference_year = [Replace With State, Settings, or System Attribute]

	results = func_estimate_escalation_factor('reference_year',)
