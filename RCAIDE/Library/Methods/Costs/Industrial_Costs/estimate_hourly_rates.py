...
## @ingroup Methods-Costs-Industrial_Costs
def func_estimate_hourly_rates(year):
...
def estimate_hourly_rates(State, Settings, System):
	#TODO: year = [Replace With State, Settings, or System Attribute]

	results = func_estimate_hourly_rates('year',)
