...
## @ingroup Methods-Geometry-Three_Dimensional
def func_compute_chord_length_from_span_location(wing,span_location):
...
def compute_chord_length_from_span_location(State, Settings, System):
	#TODO: wing          = [Replace With State, Settings, or System Attribute]
	#TODO: span_location = [Replace With State, Settings, or System Attribute]

	results = func_compute_chord_length_from_span_location('wing', 'span_location')
