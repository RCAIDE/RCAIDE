...
## @ingroup Methods-Geometry-Three_Dimensional
def func_estimate_naca_4_series_internal_volume(wing, m, p): 
...
def estimate_naca_4_series_internal_volume(State, Settings, System):
	...
	results = func_estimate_naca_4_series_internal_volume('wing', 'm', 'p')
