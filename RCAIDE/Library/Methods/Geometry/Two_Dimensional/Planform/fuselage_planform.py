...
## @ingroup Methods-Geometry-Two_Dimensional-Cross_Section-Planform
def func_fuselage_planform(fuselage):
...
def fuselage_planform(State, Settings, System):
	#TODO: fuselage = [Replace With State, Settings, or System Attribute]

	results = func_fuselage_planform('fuselage',)
