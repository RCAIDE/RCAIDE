...
# ----------------------------------------------------------------------
## @ingroup Methods-Geometry-Two_Dimensional-Cross_Section-Planform
def func_horizontal_tail_planform_raymer(horizontal_stabilizer, wing,  l_ht,c_ht):
...
def horizontal_tail_planform_raymer(State, Settings, System):
	#TODO: horizontal_stabilizer = [Replace With State, Settings, or System Attribute]
	#TODO: wing                  = [Replace With State, Settings, or System Attribute]
	#TODO: l_ht                  = [Replace With State, Settings, or System Attribute]
	#TODO: c_ht                  = [Replace With State, Settings, or System Attribute]

	results = func_horizontal_tail_planform_raymer('horizontal_stabilizer', 'wing', 'l_ht', 'c_ht')
