...
def func_set_origin_non_dimensional(vehicle):
...
def func_set_origin_dimensional(vehicle):
...
def set_origin_non_dimensional(State, Settings, System):
	#TODO: vehicle = [Replace With State, Settings, or System Attribute]

	results = func_set_origin_non_dimensional('vehicle',)
...
def set_origin_dimensional(State, Settings, System):
	#TODO: vehicle = [Replace With State, Settings, or System Attribute]

	results = func_set_origin_dimensional('vehicle',)
	#TODO: [Replace results with the output of the original function]
