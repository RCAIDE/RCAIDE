...
## @ingroup Methods-Geometry-Two_Dimensional-Cross_Section-Airfoil
def func_compute_naca_4series(airfoil_geometry_file,npoints= 200, leading_and_trailing_edge_resolution_factor = 1.5 ):
...
def compute_naca_4series(State, Settings, System):
	#TODO: airfoil_geometry_file                       = [Replace With State, Settings, or System Attribute]
	#TODO: npoints                                     = [Replace With State, Settings, or System Attribute]
	#TODO: leading_and_trailing_edge_resolution_factor = [Replace With State, Settings, or System Attribute]

	results = func_compute_naca_4series('airfoil_geometry_file', 'npoints', 'leading_and_trailing_edge_resolution_factor')
