...
def func_generate_interpolated_airfoils(a1, a2, nairfoils, npoints=200, save_filename="Transition"):
...
def generate_interpolated_airfoils(State, Settings, System):
	#TODO: a1            = [Replace With State, Settings, or System Attribute]
	#TODO: a2            = [Replace With State, Settings, or System Attribute]
	#TODO: nairfoils     = [Replace With State, Settings, or System Attribute]
	#TODO: npoints       = [Replace With State, Settings, or System Attribute]
	#TODO: save_filename = [Replace With State, Settings, or System Attribute]

	results = func_generate_interpolated_airfoils('a1', 'a2', 'nairfoils', 'npoints', 'save_filename')
