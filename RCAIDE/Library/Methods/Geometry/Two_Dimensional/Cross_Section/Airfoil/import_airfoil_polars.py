...
## @ingroup Methods-Geometry-Two_Dimensional-Cross_Section-Airfoil
def func_import_airfoil_polars(airfoil_polar_files,angel_of_attack_discretization = 89):
...
def import_airfoil_polars(State, Settings, System):
	#TODO: airfoil_polar_files            = [Replace With State, Settings, or System Attribute]
	#TODO: angel_of_attack_discretization = [Replace With State, Settings, or System Attribute]

	results = func_import_airfoil_polars('airfoil_polar_files', 'angel_of_attack_discretization')
