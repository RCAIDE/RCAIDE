...
def generate_interpolated_airfoils(airfoil_1, airfoil_2, nairfoils, npoints=201, save_filename="airfoil"):
    ...
    for j in range(nairfoils-2):
        ...
        y_n_u = rp.reshape(y_n_upper[j+1],(npoints//2,1))
        y_n_l = rp.reshape(y_n_lower[j+1],(npoints//2,1))
        x_n_u = rp.reshape(x_n_upper[j+1],(npoints//2,1))
        x_n_l = rp.reshape(x_n_lower[j+1],(npoints//2,1))
