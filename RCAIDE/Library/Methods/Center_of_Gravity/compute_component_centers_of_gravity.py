...
## @ingroup Methods-Center_of_Gravity
def func_compute_component_centers_of_gravity(vehicle, nose_load = 0.06):
...
def compute_component_centers_of_gravity(State, Settings, System):
	...
	results = func_compute_component_centers_of_gravity('vehicle', 'nose_load')
