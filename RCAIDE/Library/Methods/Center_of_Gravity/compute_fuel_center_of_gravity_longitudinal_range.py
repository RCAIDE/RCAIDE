...
## @ingroup Methods-Center_of_Gravity
def func_plot_cg_map(masses,cg_mins,cg_maxes,empty_mass=0,empty_cg=0, units='metric',
...
## @ingroup Methods-Center_of_Gravity
def func_compute_fuel_center_of_gravity_longitudinal_range(vehicle):
...
def plot_cg_map(State, Settings, System):
	#TODO: masses         = [Replace With State, Settings, or System Attribute]
	#TODO: cg_mins        = [Replace With State, Settings, or System Attribute]
	#TODO: cg_maxes       = [Replace With State, Settings, or System Attribute]
	#TODO: empty_mass     = [Replace With State, Settings, or System Attribute]
	#TODO: empty_cg       = [Replace With State, Settings, or System Attribute]
	#TODO: units          = [Replace With State, Settings, or System Attribute]
	#TODO: special_length = [Replace With State, Settings, or System Attribute]
	#TODO: fig_title      = [Replace With State, Settings, or System Attribute]

	results = func_plot_cg_map('masses', 'cg_mins', 'cg_maxes', 'empty_mass', 'empty_cg', 'units', 'special_length', 'fig_title')
...
def compute_fuel_center_of_gravity_longitudinal_range(State, Settings, System):
	#TODO: vehicle = [Replace With State, Settings, or System Attribute]

	results = func_compute_fuel_center_of_gravity_longitudinal_range('vehicle',)
	#TODO: [Replace results with the output of the original function]
