...
from RCAIDE.Library.Methods.Aeroacoustics.Metrics import * 
from RCAIDE.Library.Methods.Aeroacoustics.Metrics.PNL_noise_metric                            import PNL_noise_metric 
from RCAIDE.Library.Methods.Aeroacoustics.Metrics.EPNL_noise_metric                           import EPNL_noise_metric 
from RCAIDE.Library.Methods.Aeroacoustics.Metrics.Equivalent_SENEL_SEL_noise_metrics          import Equivalent_SENEL_SEL_noise_metrics
...
from RCAIDE.Library.Methods.Aeroacoustics.Common.generate_terrain_microphone_locations        import generate_terrain_microphone_locations     
from RCAIDE.Library.Methods.Aeroacoustics.Common.compute_relative_noise_evaluation_locations  import compute_relative_noise_evaluation_locations
...
def post_process_noise_data(results,
    ...
    results : Results
        RCAIDE results data structure containing:
            - segments[i].analyses.aeroacoustics.settings
    ...
    **Definitions**
    ...
    RCAIDE.Library.Methods.Aeroacoustics.Common.background_noise : Background noise floor function
    """

    # Step 1: Unpack settings      
    settings   = results.segments[0].analyses.aeroacoustics.settings
