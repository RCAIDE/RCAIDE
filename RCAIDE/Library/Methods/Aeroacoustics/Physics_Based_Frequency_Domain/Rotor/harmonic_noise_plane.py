# RCAIDE/Methods/Aeroacoustics/Multi_Fidelity/harmonic_noise_plane.py
# 
# 
...
# ---------------------------------------------------------------------------------------------------------------------- 
def harmonic_noise_plane(conditions,coordinates,rotor,settings,aeroacoustics,cpt):
    ...
    aeroacoustics.f= B*m_3*omega_3/(2*np.pi)
