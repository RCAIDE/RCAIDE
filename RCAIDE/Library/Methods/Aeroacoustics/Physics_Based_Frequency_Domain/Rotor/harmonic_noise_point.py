# RCAIDE/Methods/Aeroacoustics/Multi_Fidelity/harmonic_noise_point.py
# 
# 
...
# ---------------------------------------------------------------------------------------------------------------------- 
def harmonic_noise_point(conditions,coordinates,rotor,settings,aeroacoustics,cpt):
    ...
    aeroacoustics.SPL_prop_harmonic_bpf_spectrum     = 20*np.log10((abs(P_Lm_abs + P_Vm_abs))/p_ref)  
