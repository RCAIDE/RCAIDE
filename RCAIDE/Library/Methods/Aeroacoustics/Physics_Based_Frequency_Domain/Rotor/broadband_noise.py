# RCAIDE/Methods/Aeroacoustics/Physics_Based/Rotor/broadband_noise.py
# 
# 
...
from RCAIDE.Library.Methods.Aeroacoustics.Physics_Based_Frequency_Domain.Rotor.BPM_boundary_layer_properties import BPM_boundary_layer_properties
from RCAIDE.Library.Methods.Aeroacoustics.Physics_Based_Frequency_Domain.Rotor.LBL_VS_broadband_noise        import LBL_VS_broadband_noise
from RCAIDE.Library.Methods.Aeroacoustics.Physics_Based_Frequency_Domain.Rotor.TBL_TE_broadband_noise        import TBL_TE_broadband_noise
from RCAIDE.Library.Methods.Aeroacoustics.Physics_Based_Frequency_Domain.Rotor.TIP_broadband_noise           import TIP_broadband_noise 
...
# ----------------------------------------------------------------------------------------------------------------------
def broadband_noise(conditions,coordinates,rotor,settings,aeroacoustics,cpt):
    ...
    if np.all(Omega == 0):
        ...
        aeroacoustics.SPL_prop_broadband_1_3_spectrum               = aeroacoustics.SPL_prop_broadband_spectrum     # already in 1/3 octave spectrum
