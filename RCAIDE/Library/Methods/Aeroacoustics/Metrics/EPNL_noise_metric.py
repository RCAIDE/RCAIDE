# RCAIDE/Methods/Aeroacoustics/Metrics/EPNL_noise_metric.py
# 
# 
...
def EPNL_noise_metric(PNLT):
    ...
    time history Perceived Aeroacoustics Level with Tone Correction (PNLT).
    ...
    Inputs:
        PNLT - Perceived Aeroacoustics Level with Tone Correction  [PNLdB]
     
     Outputs:
        EPNL - Effective Perceived Aeroacoustics Level             [EPNdB]
