# RCAIDE/Library/Methods/Mass_Properties/Weight_Buildups/Conventional/BWB/FLOPS/compute_operating_items_weight.py
# 
# 
...
def compute_operating_items_weight(vehicle):
    ...
    WCON        = 175 * np.ceil(int(W_cargo)/ Units.lbs * 1. / 950)  # cargo container weight 
