...
def _converge_opt(State, Settings, System):
	'''
	Framework version of converge_opt.
	Wraps converge_opt with State, Settings, System pack/unpack.
	Please see converge_opt documentation for more details.
	'''

	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = converge_opt('segment',)
...
def _get_objective(State, Settings, System):
	'''
	Framework version of get_objective.
	Wraps get_objective with State, Settings, System pack/unpack.
	Please see get_objective documentation for more details.
	'''

	#TODO: unknowns = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = get_objective('unknowns', 'segment')
	#TODO: [Replace results with the output of the original function]
...
def _get_econstraints(State, Settings, System):
	'''
	Framework version of get_econstraints.
	Wraps get_econstraints with State, Settings, System pack/unpack.
	Please see get_econstraints documentation for more details.
	'''

	#TODO: unknowns = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = get_econstraints('unknowns', 'segment')
	#TODO: [Replace results with the output of the original function]
...
def _make_bnds(State, Settings, System):
	'''
	Framework version of make_bnds.
	Wraps make_bnds with State, Settings, System pack/unpack.
	Please see make_bnds documentation for more details.
	'''

	#TODO: unknowns = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = make_bnds('unknowns', 'segment')
	#TODO: [Replace results with the output of the original function]
...
def _get_ieconstraints(State, Settings, System):
	'''
	Framework version of get_ieconstraints.
	Wraps get_ieconstraints with State, Settings, System pack/unpack.
	Please see get_ieconstraints documentation for more details.
	'''

	#TODO: unknowns = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = get_ieconstraints('unknowns', 'segment')
	#TODO: [Replace results with the output of the original function]
...
def _get_problem_pyopt(State, Settings, System):
	'''
	Framework version of get_problem_pyopt.
	Wraps get_problem_pyopt with State, Settings, System pack/unpack.
	Please see get_problem_pyopt documentation for more details.
	'''

	#TODO: unknowns = [Replace With State, Settings, or System Attribute]
	#TODO: segment  = [Replace With State, Settings, or System Attribute]

	results = get_problem_pyopt('unknowns', 'segment')
	#TODO: [Replace results with the output of the original function]
