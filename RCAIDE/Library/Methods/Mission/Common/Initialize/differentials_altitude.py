...
def _differentials_altitude(State, Settings, System):
	'''
	Framework version of differentials_altitude.
	Wraps differentials_altitude with State, Settings, System pack/unpack.
	Please see differentials_altitude documentation for more details.
	'''

	#TODO: segment = [Replace With State, Settings, or System Attribute]

	results = differentials_altitude('segment',)
