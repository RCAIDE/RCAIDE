...
def func_maximum_lift_to_drag(analyses,altitude,CL_max,up_bnd,delta_isa):
...
def maximum_lift_to_drag(State, Settings, System):
	...
	results = func_maximum_lift_to_drag('analyses', 'altitude', 'CL_max', 'up_bnd', 'delta_isa')
