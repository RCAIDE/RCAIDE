...
## @ingroup Methods-Performance
def func_electric_V_h_diagram(vehicle,
                         analyses,
                         CL_max,
                         delta_isa = 0.,
                         grid_points = 20.,
    ...
    def func_mini_mission(altitude, speed):
...
def electric_V_h_diagram(State, Settings, System):
	...
	#TODO: grid_points      = [Replace With State, Settings, or System Attribute]
	#TODO: altitude_ceiling = [Replace With State, Settings, or System Attribute]
	#TODO: max_speed        = [Replace With State, Settings, or System Attribute]
	#TODO: test_omega       = [Replace With State, Settings, or System Attribute]
	#TODO: display_plot     = [Replace With State, Settings, or System Attribute]

	results = func_electric_V_h_diagram('vehicle', 'analyses', 'CL_max', 'delta_isa', 'grid_points', 'altitude_ceiling', 'max_speed', 'test_omega', 'display_plot')
...
def mini_mission(State, Settings, System):
	...
	results = func_mini_mission('altitude', 'speed')
	#TODO: [Replace results with the output of the original function]
