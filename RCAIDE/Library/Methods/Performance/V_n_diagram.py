...
## @ingroup Methods-Performance
def func_V_n_diagram(vehicle,analyses,weight,altitude,delta_ISA):
...
def func_stall_maneuver_speeds(V_n_data):
...
def func_stall_line(V_n_data, upper_bound, lower_bound, Num_of_points, sign_flag):
...
def func_gust_loads(category_tag, V_n_data, Kg, CLa, Num_of_points, FAR_part_number, sign_flag):
...
def func_gust_dive_speed_intersection(category_tag, load_factors, gust_load_factors, airspeeds, element_num, Vc, Vd):
...
def func_post_processing(category_tag, Uref_rough, Uref_cruise, Uref_dive, V_n_data, vehicle):
...
def func_convert_keas(V_n_data):
...
def V_n_diagram(State, Settings, System):
	...
	#TODO: weight    = [Replace With State, Settings, or System Attribute]
	#TODO: altitude  = [Replace With State, Settings, or System Attribute]
	#TODO: delta_ISA = [Replace With State, Settings, or System Attribute]

	results = func_V_n_diagram('vehicle', 'analyses', 'weight', 'altitude', 'delta_ISA')
...
def stall_maneuver_speeds(State, Settings, System):
	#TODO: V_n_data = [Replace With State, Settings, or System Attribute]

	results = func_stall_maneuver_speeds('V_n_data',)
	#TODO: [Replace results with the output of the original function]
...
def stall_line(State, Settings, System):
	#TODO: V_n_data      = [Replace With State, Settings, or System Attribute]
	#TODO: upper_bound   = [Replace With State, Settings, or System Attribute]
	#TODO: lower_bound   = [Replace With State, Settings, or System Attribute]
	#TODO: Num_of_points = [Replace With State, Settings, or System Attribute]
	#TODO: sign_flag     = [Replace With State, Settings, or System Attribute]

	results = func_stall_line('V_n_data', 'upper_bound', 'lower_bound', 'Num_of_points', 'sign_flag')
	#TODO: [Replace results with the output of the original function]
...
def gust_loads(State, Settings, System):
	#TODO: category_tag    = [Replace With State, Settings, or System Attribute]
	#TODO: V_n_data        = [Replace With State, Settings, or System Attribute]
	#TODO: Kg              = [Replace With State, Settings, or System Attribute]
	#TODO: CLa             = [Replace With State, Settings, or System Attribute]
	#TODO: Num_of_points   = [Replace With State, Settings, or System Attribute]
	#TODO: FAR_part_number = [Replace With State, Settings, or System Attribute]
	#TODO: sign_flag       = [Replace With State, Settings, or System Attribute]

	results = func_gust_loads('category_tag', 'V_n_data', 'Kg', 'CLa', 'Num_of_points', 'FAR_part_number', 'sign_flag')
	#TODO: [Replace results with the output of the original function]
...
def gust_dive_speed_intersection(State, Settings, System):
	#TODO: category_tag      = [Replace With State, Settings, or System Attribute]
	#TODO: load_factors      = [Replace With State, Settings, or System Attribute]
	#TODO: gust_load_factors = [Replace With State, Settings, or System Attribute]
	#TODO: airspeeds         = [Replace With State, Settings, or System Attribute]
	#TODO: element_num       = [Replace With State, Settings, or System Attribute]
	#TODO: Vc                = [Replace With State, Settings, or System Attribute]
	#TODO: Vd                = [Replace With State, Settings, or System Attribute]

	results = func_gust_dive_speed_intersection('category_tag', 'load_factors', 'gust_load_factors', 'airspeeds', 'element_num', 'Vc', 'Vd')
	#TODO: [Replace results with the output of the original function]
...
def post_processing(State, Settings, System):
	#TODO: category_tag = [Replace With State, Settings, or System Attribute]
	#TODO: Uref_rough   = [Replace With State, Settings, or System Attribute]
	#TODO: Uref_cruise  = [Replace With State, Settings, or System Attribute]
	#TODO: Uref_dive    = [Replace With State, Settings, or System Attribute]
	#TODO: V_n_data     = [Replace With State, Settings, or System Attribute]
	#TODO: vehicle      = [Replace With State, Settings, or System Attribute]

	results = func_post_processing('category_tag', 'Uref_rough', 'Uref_cruise', 'Uref_dive', 'V_n_data', 'vehicle')
	#TODO: [Replace results with the output of the original function]
...
def convert_keas(State, Settings, System):
	#TODO: V_n_data = [Replace With State, Settings, or System Attribute]

	results = func_convert_keas('V_n_data',)
	#TODO: [Replace results with the output of the original function]
