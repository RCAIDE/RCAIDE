...
propeller_range_endurance_speeds(State, Settings, System):
...
stall_speed(State, Settings, System):
	#TODO: analyses  = [Replace With State, Settings, or System Attribute]
...
mini_mission(State, Settings, System):
...
single_point_3_halves(State, Settings, System):
...
single_point_LDmax(State, Settings, System):
	#TODO: X = [Replace With State, Settings, or System Attribute]
