...
def func_propeller_range_endurance_speeds(analyses,altitude,CL_max,up_bnd,delta_isa):
        ...
        def func_single_point_3_halves(X):
...
def func_stall_speed(analyses,mass,CL_max,altitude,delta_isa):
...
def propeller_range_endurance_speeds(State, Settings, System):
	...
	#TODO: CL_max    = [Replace With State, Settings, or System Attribute]
	#TODO: up_bnd    = [Replace With State, Settings, or System Attribute]
	#TODO: delta_isa = [Replace With State, Settings, or System Attribute]

	results = func_propeller_range_endurance_speeds('analyses', 'altitude', 'CL_max', 'up_bnd', 'delta_isa')
...
def stall_speed(State, Settings, System):
	#TODO: analyses  = [Replace With State, Settings, or System Attribute]
	...
	results = func_stall_speed('analyses', 'mass', 'CL_max', 'altitude', 'delta_isa')
	#TODO: [Replace results with the output of the original function]
...
def mini_mission(State, Settings, System):

	results = func_mini_mission()
	#TODO: [Replace results with the output of the original function]
...
def single_point_3_halves(State, Settings, System):
	#TODO: X = [Replace With State, Settings, or System Attribute]

	results = func_single_point_3_halves('X',)
	#TODO: [Replace results with the output of the original function]
...
def single_point_LDmax(State, Settings, System):
	#TODO: X = [Replace With State, Settings, or System Attribute]

	results = func_single_point_LDmax('X',)
	#TODO: [Replace results with the output of the original function]
