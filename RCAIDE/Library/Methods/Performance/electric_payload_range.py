...
## @ingroup Methods-Performance
def func_electric_payload_range(vehicle,
                           mission,
                           cruise_segment_tag,
                           display_plot=True,
                           unit='mile'):
...
def electric_payload_range(State, Settings, System):
	#TODO: vehicle            = [Replace With State, Settings, or System Attribute]
	#TODO: mission            = [Replace With State, Settings, or System Attribute]
	#TODO: cruise_segment_tag = [Replace With State, Settings, or System Attribute]
	#TODO: display_plot       = [Replace With State, Settings, or System Attribute]
	#TODO: unit               = [Replace With State, Settings, or System Attribute]

	results = func_electric_payload_range('vehicle', 'mission', 'cruise_segment_tag', 'display_plot', 'unit')
