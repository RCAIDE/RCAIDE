...
## @ingroup Methods-Performance
def func_estimate_take_off_field_length(vehicle,analyses,airport,compute_2nd_seg_climb = 0):
...
def estimate_take_off_field_length(State, Settings, System):
	...
	#TODO: airport               = [Replace With State, Settings, or System Attribute]
	#TODO: compute_2nd_seg_climb = [Replace With State, Settings, or System Attribute]

	results = func_estimate_take_off_field_length('vehicle', 'analyses', 'airport', 'compute_2nd_seg_climb')
