...
## @defgroup Methods-Propulsion-Rotor_Wake-Fidelity_Zero
def func_fidelity_zero_wake_convergence(wake,rotor,wake_inputs):
    """
...
## @defgroup Methods-Propulsion-Rotor_Wake-Fidelity_Zero
def func_iteration(PSI, wake_inputs, rotor):
    """
...
## @defgroup Methods-Propulsion-Rotor_Wake-Fidelity_Zero
def func_va_vt(PSI, wake_inputs, rotor):
    """
...
## @defgroup Methods-Propulsion-Rotor_Wake-Fidelity_Zero
def func_compute_dR_dpsi(PSI,wake_inputs,rotor):
    """
...
def fidelity_zero_wake_convergence(State, Settings, System):
	#TODO: wake        = [Replace With State, Settings, or System Attribute]
	#TODO: rotor       = [Replace With State, Settings, or System Attribute]
	#TODO: wake_inputs = [Replace With State, Settings, or System Attribute]

	results = func_fidelity_zero_wake_convergence('wake', 'rotor', 'wake_inputs')
...
def iteration(State, Settings, System):
	#TODO: PSI         = [Replace With State, Settings, or System Attribute]
	#TODO: wake_inputs = [Replace With State, Settings, or System Attribute]
	#TODO: rotor       = [Replace With State, Settings, or System Attribute]

	results = func_iteration('PSI', 'wake_inputs', 'rotor')
	#TODO: [Replace results with the output of the original function]
...
def va_vt(State, Settings, System):
	#TODO: PSI         = [Replace With State, Settings, or System Attribute]
	#TODO: wake_inputs = [Replace With State, Settings, or System Attribute]
	#TODO: rotor       = [Replace With State, Settings, or System Attribute]

	results = func_va_vt('PSI', 'wake_inputs', 'rotor')
	#TODO: [Replace results with the output of the original function]
...
def compute_dR_dpsi(State, Settings, System):
	#TODO: PSI         = [Replace With State, Settings, or System Attribute]
	#TODO: wake_inputs = [Replace With State, Settings, or System Attribute]
	#TODO: rotor       = [Replace With State, Settings, or System Attribute]

	results = func_compute_dR_dpsi('PSI', 'wake_inputs', 'rotor')
	#TODO: [Replace results with the output of the original function]
