...
compute_wake_induced_velocity(State, Settings, System):
...
row_reduction_summation(State, Settings, System):
...
regularization_kernel(State, Settings, System):
