...
## @ingroup Methods-Propulsion
def func_serial_HTS_turboelectric_sizing(Turboelectric_HTS_Ducted_Fan,mach_number = None, altitude = None, delta_isa = 0, conditions = None, cryo_cold_temp = 50.0, cryo_amb_temp = 300.0):  
...
def serial_HTS_turboelectric_sizing(State, Settings, System):
	#TODO: Turboelectric_HTS_Ducted_Fan = [Replace With State, Settings, or System Attribute]
	...
	results = func_serial_HTS_turboelectric_sizing('Turboelectric_HTS_Ducted_Fan', 'mach_number', 'altitude', 'delta_isa', 'conditions', 'cryo_cold_temp', 'cryo_amb_temp')
