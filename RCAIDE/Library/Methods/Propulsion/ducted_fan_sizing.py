...
## @ingroup Methods-Propulsion
def func_ducted_fan_sizing(ducted_fan,mach_number = None, altitude = None, delta_isa = 0, conditions = None):  
    """
...
def ducted_fan_sizing(State, Settings, System):
	#TODO: ducted_fan  = [Replace With State, Settings, or System Attribute]
	...
	results = func_ducted_fan_sizing('ducted_fan', 'mach_number', 'altitude', 'delta_isa', 'conditions')
