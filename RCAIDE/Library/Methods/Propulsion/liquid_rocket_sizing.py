...
# ----------------------------------------------------------------------
## @ingroup Methods-Propulsion
def func_liquid_rocket_sizing(liquid_rocket, altitude = None, delta_isa = 0, conditions = None):  
...
def liquid_rocket_sizing(State, Settings, System):
	#TODO: liquid_rocket = [Replace With State, Settings, or System Attribute]
	...
	results = func_liquid_rocket_sizing('liquid_rocket', 'altitude', 'delta_isa', 'conditions')
