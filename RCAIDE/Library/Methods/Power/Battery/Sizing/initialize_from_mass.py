...
# ----------------------------------------------------------------------
## @ingroup Methods-Power-Battery-Sizing
def func_initialize_from_mass(battery,module_weight_factor = 1.42 ):
    """
...
def initialize_from_mass(State, Settings, System):
	...
	results = func_initialize_from_mass('battery', 'module_weight_factor')
