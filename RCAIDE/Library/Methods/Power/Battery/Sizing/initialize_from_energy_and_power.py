...
# ----------------------------------------------------------------------
## @ingroup Methods-Power-Battery-Sizing
def func_initialize_from_energy_and_power(battery, energy, power, max='hard'):
    """
...
def initialize_from_energy_and_power(State, Settings, System):
	...
	results = func_initialize_from_energy_and_power('battery', 'energy', 'power', 'max')
