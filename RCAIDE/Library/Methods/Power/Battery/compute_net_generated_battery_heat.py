...
# ----------------------------------------------------------------------
## @ingroup Methods-Power-Battery 
def func_compute_net_generated_battery_heat(n_total,battery,Q_heat_gen,numerics):
...
def compute_net_generated_battery_heat(State, Settings, System):
	...
	results = func_compute_net_generated_battery_heat('n_total', 'battery', 'Q_heat_gen', 'numerics')
