...
# make_VLM_wings()
# ----------------------------------------------------------------------------------------------------------------------
def make_VLM_wings_new(geometry, settings):
    ...
    """ 
    # unpack inputs 
    VLM_wings   = deepcopy(geometry.wings) 

    # ------------------------------------------------------------------
    # Remove any segments with ignore flag as well as spoilers since they cant be modelded 
    # ------------------------------------------------------------------
    for wing in VLM_wings:
