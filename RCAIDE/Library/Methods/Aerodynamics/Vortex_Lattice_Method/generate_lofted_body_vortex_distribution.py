# RCAIDE/Library/Methods/Aerodynamics/Vortex_Lattice_Method/generate_lofted_body_vortex_distribution.py
# 
...
# ----------------------------------------------------------------------
#  Discretize Fuselage and Nacelles
# ----------------------------------------------------------------------
def generate_lofted_body_vortex_distribution(VD,fus,n_cw,n_sw,precision,model_geometry=False):
