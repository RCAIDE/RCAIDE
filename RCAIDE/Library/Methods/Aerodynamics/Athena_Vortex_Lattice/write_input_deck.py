...
'''     
    ...
    if case.conditions.aerodynamics.coefficients.lift.inviscid.total== None:
        condition = 'A'
        val       = case.conditions.aerodynamics.angles.alpha
    elif case.conditions.aerodynamics.coefficients.lift.inviscid.total > 0:  
        condition = 'C'
        val       = case.conditions.aerodynamics.coefficients.lift.inviscid.total
    else:   
        trim_command = ''
        return trim_command
