...
translate_avl_wing(State, Settings, System):
...
translate_avl_body(State, Settings, System):
...
populate_wing_sections(State, Settings, System):
...
append_avl_wing_control_surfaces(State, Settings, System):
	#TODO: suave_wing         = [Replace With State, Settings, or System Attribute]
	#TODO: avl_wing           = [Replace With State, Settings, or System Attribute]
...
populate_body_sections(State, Settings, System):
