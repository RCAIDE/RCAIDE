...
write_geometry(State, Settings, System):
...
make_header_text(State, Settings, System):
	#TODO: avl_object = [Replace With State, Settings, or System Attribute]
...
make_surface_text(State, Settings, System):
...
make_body_text(State, Settings, System):
...
make_wing_section_text(State, Settings, System):
...
make_body_section_text(State, Settings, System):
...
make_controls_text(State, Settings, System):
