...
# ----------------------------------------------------------------------  
## @ingroup Methods-Aerodynamics-Airfoil_Panel_Method
def func_infl_coeff(x,y,xbar,ybar,st,ct,npanel,ncases,ncpts):
...
def infl_coeff(State, Settings, System):
	...
	results = func_infl_coeff('x', 'y', 'xbar', 'ybar', 'st', 'ct', 'npanel', 'ncases', 'ncpts')
