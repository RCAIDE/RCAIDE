...
## @ingroup Methods-Aerodynamics-Airfoil_Panel_Method
def func_velocity_distribution(qg,x,y,xbar,ybar,st,ct,alpha_2d,npanel):
...
def velocity_distribution(State, Settings, System):
	#TODO: qg       = [Replace With State, Settings, or System Attribute]
	...
	#TODO: ybar     = [Replace With State, Settings, or System Attribute]
	#TODO: st       = [Replace With State, Settings, or System Attribute]
	#TODO: ct       = [Replace With State, Settings, or System Attribute]
	#TODO: alpha_2d = [Replace With State, Settings, or System Attribute]
	#TODO: npanel   = [Replace With State, Settings, or System Attribute]

	results = func_velocity_distribution('qg', 'x', 'y', 'xbar', 'ybar', 'st', 'ct', 'alpha_2d', 'npanel')
