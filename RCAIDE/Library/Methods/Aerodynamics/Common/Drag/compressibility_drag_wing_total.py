...
def compressibility_drag_wing_total(state,settings,geometry):
    ...
    for wing in geometry.wings:
        ...
        compressibility_drag = state.conditions.aerodynamics.coefficients.drag.breakdown.compressible[wing.tag].compressibility_drag
        state.conditions.aerodynamics.coefficients.drag.breakdown.compressible[wing.tag].compressibility_drag = compressibility_drag * 1. # avoid linking variables
