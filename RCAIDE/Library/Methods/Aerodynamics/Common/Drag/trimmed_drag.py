...
def trimmed_drag(state,settings,geometry):
    ...
    Args:
        ...
        state.conditions.aerodynamics.coefficients.
                          drag.untrimmed (numpy.ndarray): untrimmed drag [Unitless]
    ...
    untrimmed_drag          = state.conditions.aerodynamics.coefficients.drag.untrimmed
    
    # trim correction
    corrected_aircraft_total_trim_drag = trim_correction_factor * untrimmed_drag
    
    state.conditions.aerodynamics.coefficients.drag.trim_corrected_drag                  = corrected_aircraft_total_trim_drag    
