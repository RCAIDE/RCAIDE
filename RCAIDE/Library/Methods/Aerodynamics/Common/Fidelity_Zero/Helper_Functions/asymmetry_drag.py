...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Helper_Functions
def func_asymmetry_drag(state, geometry, windmilling_drag_coefficient = 0.):
...
def asymmetry_drag(State, Settings, System):
	#TODO: state                        = [Replace With State, Settings, or System Attribute]
	#TODO: geometry                     = [Replace With State, Settings, or System Attribute]
	#TODO: windmilling_drag_coefficient = [Replace With State, Settings, or System Attribute]

	results = func_asymmetry_drag('state', 'geometry', 'windmilling_drag_coefficient')
