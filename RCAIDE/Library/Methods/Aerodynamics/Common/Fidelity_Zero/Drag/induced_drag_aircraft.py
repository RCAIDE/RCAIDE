...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Drag
def func_induced_drag_aircraft(state,settings,geometry):
...
def induced_drag_aircraft(State, Settings, System):
	...
	results = func_induced_drag_aircraft('state', 'settings', 'geometry')
