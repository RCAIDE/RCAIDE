...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Drag
def func_compressibility_drag_wing(state,settings,geometry):
...
def compressibility_drag_wing(State, Settings, System):
	...
	results = func_compressibility_drag_wing('state', 'settings', 'geometry')
