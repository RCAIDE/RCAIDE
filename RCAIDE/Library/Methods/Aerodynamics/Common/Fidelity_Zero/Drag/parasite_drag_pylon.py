...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Drag
def func_parasite_drag_pylon(state,settings,geometry):
...
def parasite_drag_pylon(State, Settings, System):
	...
	results = func_parasite_drag_pylon('state', 'settings', 'geometry')
