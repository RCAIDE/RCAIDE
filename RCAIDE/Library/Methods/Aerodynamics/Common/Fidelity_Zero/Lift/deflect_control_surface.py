...
deflect_control_surfaces(State, Settings, System):
...
deflect_control_surface(State, Settings, System):
	#TODO: VD   = [Replace With State, Settings, or System Attribute]
...
deflect_control_surface_strip(State, Settings, System):
	#TODO: wing           = [Replace With State, Settings, or System Attribute]
...
make_hinge_quaternion(State, Settings, System):
...
rotate_points_with_quaternion(State, Settings, System):
