...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_extract_wing_collocation_points(geometry, wing_instance_idx):
...
def extract_wing_collocation_points(State, Settings, System):
	#TODO: geometry          = [Replace With State, Settings, or System Attribute]
	#TODO: wing_instance_idx = [Replace With State, Settings, or System Attribute]

	results = func_extract_wing_collocation_points('geometry', 'wing_instance_idx')
