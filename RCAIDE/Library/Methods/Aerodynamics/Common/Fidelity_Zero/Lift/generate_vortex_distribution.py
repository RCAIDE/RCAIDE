...
generate_vortex_distribution(State, Settings, System):
...
generate_wing_vortex_distribution(State, Settings, System):
...
generate_fuselage_and_nacelle_vortex_distribution(State, Settings, System):
	#TODO: VD             = [Replace With State, Settings, or System Attribute]
