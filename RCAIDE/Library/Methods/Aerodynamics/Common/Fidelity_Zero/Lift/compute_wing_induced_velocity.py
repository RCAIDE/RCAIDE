...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_compute_wing_induced_velocity(VD,mach,compute_EW=False):
...
def func_subsonic(Z,XSQ1,RO1,XSQ2,RO2,XTY,T,B2,ZSQ,TOLSQ,X1,Y1,X2,Y2,RTV1,RTV2):
...
def func_supersonic(Z,XSQ1,RO1,XSQ2,RO2,XTY,T,B2,ZSQ,TOLSQ,TOL,TOLSQ2,X1,Y1,X2,Y2,RTV1,RTV2,CUTOFF,CHORD,RNMAX,n_cp,TE_ind, LE_ind):
    """  This computes the induced velocities at each control point 
...
def func_supersonic_in_plane(RAD1,RAD2,Y1,Y2,TOL,XTY,CPI):
    """  This computes the induced velocities at each control point 
...
def compute_wing_induced_velocity(State, Settings, System):
	...
	results = func_compute_wing_induced_velocity('VD', 'mach', 'compute_EW')
...
def subsonic(State, Settings, System):
	...
	results = func_subsonic('Z', 'XSQ1', 'RO1', 'XSQ2', 'RO2', 'XTY', 'T', 'B2', 'ZSQ', 'TOLSQ', 'X1', 'Y1', 'X2', 'Y2', 'RTV1', 'RTV2')
	#TODO: [Replace results with the output of the original function]
...
def supersonic(State, Settings, System):
	#TODO: Z      = [Replace With State, Settings, or System Attribute]
	#TODO: XSQ1   = [Replace With State, Settings, or System Attribute]
	#TODO: RO1    = [Replace With State, Settings, or System Attribute]
	#TODO: XSQ2   = [Replace With State, Settings, or System Attribute]
	...
	results = func_supersonic('Z', 'XSQ1', 'RO1', 'XSQ2', 'RO2', 'XTY', 'T', 'B2', 'ZSQ', 'TOLSQ', 'TOL', 'TOLSQ2', 'X1', 'Y1', 'X2', 'Y2', 'RTV1', 'RTV2', 'CUTOFF', 'CHORD', 'RNMAX', 'n_cp', 'TE_ind', 'LE_ind')
	#TODO: [Replace results with the output of the original function]
...
def supersonic_in_plane(State, Settings, System):
	...
	results = func_supersonic_in_plane('RAD1', 'RAD2', 'Y1', 'Y2', 'TOL', 'XTY', 'CPI')
	#TODO: [Replace results with the output of the original function]
