...
make_VLM_wings(State, Settings, System):
...
copy_wings(State, Settings, System):
...
copy_large_container(State, Settings, System):
...
copy_data_from_paths(State, Settings, System):
...
recursive_set(State, Settings, System):
...
get_paths(State, Settings, System):
	#TODO: type_str = [Replace With State, Settings, or System Attribute]
...
make_cs_wing_from_cs(State, Settings, System):
...
convert_to_segmented_wing(State, Settings, System):
	#TODO: wing = [Replace With State, Settings, or System Attribute]
...
add_span_break(State, Settings, System):
...
reprocess_span_breaks(State, Settings, System):
	#TODO: span_breaks = [Replace With State, Settings, or System Attribute]
...
make_span_break_from_segment(State, Settings, System):
...
make_span_breaks_from_cs(State, Settings, System):
	#TODO: cs      = [Replace With State, Settings, or System Attribute]
	#TODO: seg_a   = [Replace With State, Settings, or System Attribute]
	#TODO: seg_b   = [Replace With State, Settings, or System Attribute]
...
make_span_break(State, Settings, System):
	#TODO: cs_ID       = [Replace With State, Settings, or System Attribute]
...
make_span_break_tag(State, Settings, System):
	#TODO: span_break = [Replace With State, Settings, or System Attribute]
