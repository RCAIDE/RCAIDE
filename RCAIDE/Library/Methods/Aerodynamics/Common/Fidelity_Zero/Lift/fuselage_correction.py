...
## @ingroup Methods-Aerodynamics-Common-Fidelity_Zero-Lift
def func_fuselage_correction(state,settings,geometry):  
...
def fuselage_correction(State, Settings, System):
	...
	results = func_fuselage_correction('state', 'settings', 'geometry')
