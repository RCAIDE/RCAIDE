...
## @ingroup Methods-Aerodynamics-Supersonic_Zero-Drag
def func_wave_drag_lift(conditions,configuration,wing):
...
def wave_drag_lift(State, Settings, System):
	...
	results = func_wave_drag_lift('conditions', 'configuration', 'wing')
