...
## @ingroup Methods-Aerodynamics-Supersonic_Zero-Drag
def func_wave_drag_volume_raymer(vehicle,mach,scaling_factor):
...
def wave_drag_volume_raymer(State, Settings, System):
	...
	results = func_wave_drag_volume_raymer('vehicle', 'mach', 'scaling_factor')
