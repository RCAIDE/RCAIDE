...
## @ingroup Methods-Aerodynamics-Supersonic_Zero-Drag
def func_miscellaneous_drag_aircraft(state,settings,geometry):
...
def miscellaneous_drag_aircraft(State, Settings, System):
	...
	results = func_miscellaneous_drag_aircraft('state', 'settings', 'geometry')
