...
## @ingroup Methods-Aerodynamics-Supersonic_Zero-Drag
def func_parasite_drag_fuselage(state,settings,geometry):
...
def parasite_drag_fuselage(State, Settings, System):
	...
	results = func_parasite_drag_fuselage('state', 'settings', 'geometry')
