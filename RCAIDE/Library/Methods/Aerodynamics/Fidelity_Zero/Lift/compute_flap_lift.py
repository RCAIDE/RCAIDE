...
## @ingroup Methods-Aerodynamics-Fidelity_Zero-Lift
def func_compute_flap_lift(t_c,flap_type,flap_chord,flap_angle,sweep,wing_Sref,wing_affected_area):
...
def compute_flap_lift(State, Settings, System):
	#TODO: t_c                = [Replace With State, Settings, or System Attribute]
	#TODO: flap_type          = [Replace With State, Settings, or System Attribute]
	#TODO: flap_chord         = [Replace With State, Settings, or System Attribute]
	#TODO: flap_angle         = [Replace With State, Settings, or System Attribute]
	#TODO: sweep              = [Replace With State, Settings, or System Attribute]
	#TODO: wing_Sref          = [Replace With State, Settings, or System Attribute]
	#TODO: wing_affected_area = [Replace With State, Settings, or System Attribute]

	results = func_compute_flap_lift('t_c', 'flap_type', 'flap_chord', 'flap_angle', 'sweep', 'wing_Sref', 'wing_affected_area')
