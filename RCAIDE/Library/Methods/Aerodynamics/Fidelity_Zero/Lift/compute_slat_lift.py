...
## @ingroup Methods-Aerodynamics-Fidelity_Zero-Lift
def func_compute_slat_lift(slat_angle,sweep_angle):
...
def compute_slat_lift(State, Settings, System):
	#TODO: slat_angle  = [Replace With State, Settings, or System Attribute]
	#TODO: sweep_angle = [Replace With State, Settings, or System Attribute]

	results = func_compute_slat_lift('slat_angle', 'sweep_angle')
