...
## @ingroup Methods-Aerodynamics-Fidelity_Zero-Lift
def func_compute_max_lift_coeff(state,settings,geometry):
...
def compute_max_lift_coeff(State, Settings, System):
	...
	results = func_compute_max_lift_coeff('state', 'settings', 'geometry')
