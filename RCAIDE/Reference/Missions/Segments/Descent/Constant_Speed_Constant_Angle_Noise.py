...
class Constant_Speed_Constant_Angle_Noise(Evaluate):
    ...
    def __defaults__(self):
        ...
        initialize.expand_state            = RCAIDE.Framework.Missions.Mission.Mission.Segments.Descent.Constant_Speed_Constant_Angle_Noise.expand_state
        initialize.conditions              = RCAIDE.Framework.Missions.Mission.Mission.Segments.Descent.Constant_Speed_Constant_Angle_Noise.initialize_conditions
