# RCAIDE/Framework/Functions/Segments/Single_Point/Set_Speed_Set_Altitude_No_Propulsion.py
...
class Set_Speed_Set_Altitude_No_Propulsion(Evaluate):
    ...
    def __defaults__(self):
        ...
        initialize.conditions              = RCAIDE.Framework.Mission.Mission.Segments.Single_Point.Set_Speed_Set_Altitude_No_Propulsion.initialize_conditions
