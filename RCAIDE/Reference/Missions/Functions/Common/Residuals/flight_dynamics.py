...
#  IMPORT
# ----------------------------------------------------------------------------------------------------------------------
from RCAIDE.Reference.Missions.Segments import (Constant_Acceleration_Constant_Angle_Linear_Climb
                                                          as Transition_Segment)
from RCAIDE.Reference.Missions.Segments.Ground import Landing, Takeoff, Ground
