...
# RCAIDE/Analyses/Aerodynamics/Vortex_Lattice.py
...
from RCAIDE.Methods.Aerodynamics.Common.Lift import VLM 
...
class Vortex_Lattice(Aerodynamics):
    ...
    def sample_training(self):
        ...
        # Setup Konditions    
        konditions                              = RCAIDE.Analyses.Mission.Segments.Conditions.Aerodynamics()
