...
def plot_3d_vehicle(vehicle,
    ...
    plot_data,x_min,x_max,y_min,y_max,z_min,z_max  = generate_3d_vehicle_geometry_data(plot_data,vehicle,alpha,show_wing_control_points,show_rotor_wake_vortex_core,x_axis_limit,y_axis_limit,z_axis_limit)
...
def generate_3d_vehicle_geometry_data(plot_data,
    ...
    return plot_data,x_min,x_max,y_min,y_max,z_min,z_max 
