# RCAIDE/Framework/Analyses/Weights/Electric_General_Aviation.py
#
...
# ----------------------------------------------------------------------------------------------------------------------
class Electric_General_Aviation(Electric):
    """ This is class that evaluates the weight of an electric general aviation class aircraft
