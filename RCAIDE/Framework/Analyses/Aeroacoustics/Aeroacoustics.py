# RCAIDE/Framework/Analyses/Aeroacoustics/Aeroacoustics.py
# 
# 
...
#  Aeroacoustics
# ----------------------------------------------------------------------
class Aeroacoustics(Analysis):
    """ RCAIDE.Framework.Analyses.Aeroacoustics.Aeroacoustics()
    
        The Top Level Aeroacoustics Analysis Class
    ...
    def __defaults__(self):
        ...
        epsilon                                              = 1E-10
        self.settings.noise_hemisphere_phi_angles            = np.linspace(epsilon,   np.pi-epsilon,6)   
        self.settings.noise_hemisphere_theta_angles          = np.linspace(epsilon - np.pi        ,   np.pi-epsilon,12)
