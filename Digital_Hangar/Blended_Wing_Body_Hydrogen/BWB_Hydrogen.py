...
def vehicle_setup():  
    ...
    vehicle.tag                                       = 'BOB' 
    vehicle.mass_properties.max_takeoff               = 112000   
    ...
    fuel_tank_2.segments_percent_chord_end             = [0.5,0.5]
    ...
    fuel_tank_3.segments_percent_chord_start           = [0.1,0.1]
    fuel_tank_3.segments_percent_chord_end             = [0.5,0.5]
