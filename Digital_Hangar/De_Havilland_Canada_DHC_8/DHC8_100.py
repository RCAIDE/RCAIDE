...
def main():
    ...
    try:
        ...
        export_vsp_vehicle(vehicle, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'De_Havilland_DHC8_100'))
    except ImportError:
        pass
        
    # Step 2: plot vehicle 
    plot_3d_vehicle(vehicle,save_filename=os.path.join(os.path.dirname(os.path.abspath(__file__)),'DHC8_100'),export_gltf=True,show_figure=True)  
