...
def main():
    ...
    truth_values = {
        "range": np.array([ 0.        , 10432292.94892029, 17639210.97707081,       18324492.58898542]),
        "payload": np.array([44000.        , 44000.        ,  9790.42973042,   0.        ]),
        "oew_plus_payload": np.array([160816.57026958, 160816.57026958, 126607. , 116816.57026958]),
        "fuel": np.array([    0.        ,  67113.42973042, 101323.        , 101323.    ]),
        "takeoff_weight": np.array([     0.        , 227930.        , 227930.        , 218139.57026958]),
    }
    # Tolerance checks
