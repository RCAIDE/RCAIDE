...
def main(): 
    ...
    climb_throttle_1_truth   = 1.0386634181761418
    climb_throttle_2_truth   = 1.0253632024408714
    climb_throttle_3_truth   = 0.4250982535737367
    climb_throttle_4_truth   = 0.7950568454407502
    climb_throttle_5_truth   = 0.8105460715610441
    climb_throttle_6_truth   = 1.107418932260614
    climb_throttle_7_truth   = 1.2429415229513634
    climb_throttle_8_truth   = 0.4728119360845322
    climb_throttle_9_truth   = 0.7697142871705273
    climb_10_CL_truth        = 1.3978227505406666
    cruise_CL_1_truth        = 0.6798753955194002
    cruise_CL_2_truth        = 0.5614154311458951
    descent_throttle_1_truth = -0.1618557752785526
    descent_2_CL_truth       = 0.6957470285289207
    curved_cruise_CL_truth   = 1.3073176213703195
    descent_throttle_3_truth = 0.1
    single_pt_CL_1_truth     = 0.24381657265462944
    single_pt_CL_2_truth     = 0.0009859310451349032
    cruise_4_CL_truth        = 0.4968389785985158
    cruise_5_CL_truth        = 0.49683478328947506
    cruise_6_CL_truth        = 0.3368744488262454
    cruise_7_CL_truth        = 0.3295071555912165
    cruise_8_CL_truth        = 0.3229581975089642
    descent_throttle_4_truth = 0.09151971785579985
