...
def main():
    ...
    convetional_cruise_CL_truth      = 0.685899883504605
    electric_cruise_CL_truth         = 0.6922942757780376
    series_hybrid_cruise_CL_truth    = 0.69034635832371
    parallel_hybrid_cruise_CL_truth  = 0.6918449488890347
