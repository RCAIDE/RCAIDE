...
def main(): 
    ...
    X57_SPL_true   = 86.21258049555534
...
def base_analysis(vehicle):
    ...
    aeroacoustics.settings.mean_sea_level_altitude          = False         
    aeroacoustics.settings.aircraft_origin_coordinates      = [33.94067953101678, -118.40513722978149]# Los Angeles International Airport
    aeroacoustics.settings.aircraft_destination_coordinates = [33.8146, -118.1459]  # Ontario International airport 
    aeroacoustics.settings.microphone_x_resolution          = 80  
    aeroacoustics.settings.microphone_y_resolution          = 120 
    aeroacoustics.settings.noise_times_steps                = 50  
    aeroacoustics.settings.number_of_microphone_in_stencil  = 25
    aeroacoustics.settings.topography_file                  = 'LA_Metropolitan_Area.txt' 
